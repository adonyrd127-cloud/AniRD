...
import{_ as g}from"./page-watchpage-D2cZczVK.js";import{c as y,b as E,d as h}from"./page-homepage-BCn5ETVD.js";class S{constructor(){this.isActive=!1,this.focusedElement=null,this.focusableElements=[],this.handleKeyDownBound=this.handleKeyDown.bind(this),this.mutationObserver=null,this.scrollContainer=null,this.iframeFocused=!1,this._onWindowBlur=this._onWindowBlur.bind(this),this._onWindowFocus=this._onWindowFocus.bind(this)}autoDetect(){const i=(navigator.userAgent||"").includes("AniRD-AndroidTV"),l=localStorage.getItem("tvMode")==="true";(i||l)&&(console.log("📺 [AniRD] TV detectado, activando modo TV automáticamente..."),setTimeout(()=>this.init(),150))}init(){this.isActive||(this.isActive=!0,document.body.classList.add("tv-mode"),localStorage.setItem("tvMode","true"),this._updateScrollContainer(),window.addEventListener("keydown",this.handleKeyDownBound,{capture:!0}),this.setupMutationObserver(),this.lockWindowScroll(),window.addEventListener("blur",this._onWindowBlur),window.addEventListener("focus",this._onWindowFocus),setTimeout(()=>{this.updateFocusables(),this.focusFirstAvailable()},350),console.log("📺 AniRD Spatial Navigation (Smart TV Mode) initialized."))}_updateScrollContainer(){this.scrollContainer=document.getElementById("app")||document.body}destroy(){this.isActive&&(this.isActive=!1,document.body.classList.remove("tv-mode"),localStorage.setItem("tvMode","false"),window.removeEventListener("keydown",this.handleKeyDownBound,{capture:!0}),window.removeEventListener("blur",this._onWindowBlur),window.removeEventListener("focus",this._onWindowFocus),this.unlockWindowScroll(),this._iframeEscapeInterval&&(clearInterval(this._iframeEscapeInterval),this._iframeEscapeInterval=null),this.mutationObserver&&(this.mutationObserver.disconnect(),this.mutationObserver=null),this.focusedElement&&(this.focusedElement.classList.remove("focused"),this.focusedElement=null),document.querySelectorAll(".focused").forEach(e=>e.classList.remove("focused")),this.scrollContainer=null,this.iframeFocused=!1,console.log("📺 AniRD Spatial Navigation (Smart TV Mode) destroyed."))}lockWindowScroll(){this.scrollListener=e=>{(window.scrollY!==0||window.scrollX!==0)&&window.scrollTo(0,0),document.documentElement.scrollTop!==0&&(document.documentElement.scrollTop=0),document.body.scrollTop!==0&&(document.body.scrollTop=0)},window.addEventListener("scroll",this.scrollListener,{passive:!0}),window.scrollTo(0,0)}unlockWindowScroll(){this.scrollListener&&(window.removeEventListener("scroll",this.scrollListener,{passive:!0}),this.scrollListener=null)}setupMutationObserver(){this.mutationObserver&&this.mutationObserver.disconnect(),this.mutationObserver=new MutationObserver(()=>{this.updateTimeout&&clearTimeout(this.updateTimeout),this.updateTimeout=setTimeout(()=>{this.isActive&&this.updateFocusables()},200)}),this.mutationObserver.observe(document.body,{childList:!0,subtree:!0})}updateFocusables(){if(!this.isActive)return;this._updateScrollContainer();const e=["a[href]","button",'input:not([type="hidden"])',"select","textarea",'[tabindex]:not([tabindex="-1"])',"anime-card",".anime-card",".episode-btn",".sidebar-link",".search-bar-desktop",".header-profile-btn","#header-tv-toggle",".server-btn",".player-control-btn",".category-item",".sidebar-categories-trigger",".control-btn-v5",".server-pill-v5",".lang-pill-v5",".btn-more-v5",".ep-search-input-v5",".sidebar-icon-btn",".ep-item-horizontal-v5",".related-card-v5",".video-wrapper-v5",".tab-item",'[role="button"]'].join(", "),i=Array.from(document.querySelectorAll(e));this.focusableElements=i.filter(l=>{if(l.disabled||l.getAttribute("aria-disabled")==="true")return!1;if(l.id==="tv-mode-toggle"||l.id==="header-tv-toggle")return!0;const d=l.getBoundingClientRect();if(d.width===0||d.height===0)return!1;const t=window.getComputedStyle(l);if(t.display==="none"||t.visibility==="hidden"||t.opacity==="0")return!1;let s=l.parentElement;for(;s;){if(window.getComputedStyle(s).display==="none")return!1;s=s.parentElement}return!0}),this.focusedElement&&!this.focusableElements.includes(this.focusedElement)&&(this.focusedElement.classList.remove("focused"),this.focusedElement=null,this.focusFirstAvailable())}focusFirstAvailable(){if(this.focusableElements.length>0){let e=this.focusableElements.find(i=>i.classList.contains("sidebar-link")||i.tagName==="ANIME-CARD"||i.classList.contains("ep-item-horizontal-v5"));e||(e=this.focusableElements[0]),this.focusElement(e)}}focusElement(e){if(e){if(this.focusedElement&&(this.focusedElement.classList.remove("focused"),typeof this.focusedElement.blur=="function"&&this.focusedElement.blur()),this.focusedElement=e,this.focusedElement.classList.add("focused"),typeof this.focusedElement.focus=="function")try{this.focusedElement.focus({preventScroll:!0})}catch{this.focusedElement.focus()}this._scrollElementIntoView(e)}}_scrollElementIntoView(e){const i=this.scrollContainer;if(!i||i===document.body){e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"nearest"});return}const l=i.getBoundingClientRect(),d=e.getBoundingClientRect(),t=d.top-l.top+i.scrollTop,s=t+d.height,a=i.scrollTop+i.clientHeight,o=80;t-o<i.scrollTop?i.scrollTo({top:t-o,behavior:"smooth"}):s+o>a&&i.scrollTo({top:s+o-i.clientHeight,behavior:"smooth"})}_onWindowBlur(){setTimeout(()=>{if(document.activeElement&&document.activeElement.tagName==="IFRAME"){console.log("📺 [AniRD] Foco capturado por iframe — recuperando..."),document.activeElement.blur();const e=document.querySelector(".player-controls-v5 .control-btn-v5");e&&this.focusElement(e)}},150)}_onWindowFocus(){if(document.activeElement&&document.activeElement.tagName==="IFRAME"){document.activeElement.blur();const e=document.querySelector(".player-controls-v5 .control-btn-v5");e&&this.focusElement(e)}}handleKeyDown(e){var d;if(!this.isActive)return;const i=document.activeElement?document.activeElement.tagName:"",l=i==="INPUT"||i==="TEXTAREA";if(i==="IFRAME"){document.activeElement.blur();const t=document.querySelector(".player-controls-v5 .control-btn-v5");t&&this.focusElement(t),e.preventDefault(),e.stopPropagation();return}if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"].includes(e.key)){if(l&&["ArrowLeft","ArrowRight"].includes(e.key))return;e.preventDefault(),e.stopPropagation();const t=e.key.replace("Arrow","").toLowerCase();this.moveFocus(t);return}if(e.key==="Enter"){if(l)return;if(this.focusedElement)if(e.preventDefault(),e.stopPropagation(),this.focusedElement.tagName==="ANIME-CARD"){const t=(d=this.focusedElement.shadowRoot)==null?void 0:d.querySelector("a");t?t.click():this.focusedElement.click()}else if(this.focusedElement.classList.contains("video-wrapper-v5")){console.log("📺 [AniRD] Video seleccionado → Activando pantalla completa CSS");const t=document.getElementById("video-container");if(t){t.classList.toggle("tv-fullscreen-active");const s=t.classList.contains("tv-fullscreen-active"),a=document.querySelector("#btn-fullscreen-watch span");a&&(a.textContent=s?"Salir Pantalla":"Pantalla Completa")}return}else this.focusedElement.click();return}if(e.key==="Backspace"||e.key==="Escape"){if(l&&e.key==="Backspace")return;const t=document.getElementById("searchOverlay");if(t&&t.classList.contains("active"))return;const s=document.getElementById("video-container");if(s&&s.classList.contains("tv-fullscreen-active")){s.classList.remove("tv-fullscreen-active");const a=document.querySelector("#btn-fullscreen-watch span");a&&(a.textContent="Pantalla Completa"),e.preventDefault(),e.stopPropagation();return}e.preventDefault(),e.stopPropagation(),window.history.back()}}moveFocus(e){if(this.updateFocusables(),this.focusableElements.length===0)return;if(!this.focusedElement||!this.focusableElements.includes(this.focusedElement)){this.focusFirstAvailable();return}const i=this.focusedElement.getBoundingClientRect(),l=i.left+i.width/2,d=i.top+i.height/2;let t=null,s=1/0;for(const a of this.focusableElements){if(a===this.focusedElement)continue;const o=a.getBoundingClientRect(),c=o.left+o.width/2,r=o.top+o.height/2,n=c-l,u=r-d;let f=0,m=0,p=!1;switch(e){case"right":n>5&&(f=n,m=Math.abs(u),p=!0);break;case"left":n<-5&&(f=-n,m=Math.abs(u),p=!0);break;case"down":u>5&&(f=u,m=Math.abs(n),p=!0);break;case"up":u<-5&&(f=-u,m=Math.abs(n),p=!0);break}if(p){const v=f+m*3;v<s&&(s=v,t=a)}}if(t)this.focusElement(t);else if((e==="down"||e==="up")&&this.scrollContainer&&this.scrollContainer!==document.body){const a=e==="down"?300:-300;this.scrollContainer.scrollBy({top:a,behavior:"smooth"})}}}const x=new S;if(typeof document<"u"){const b=()=>x.autoDetect();document.readyState==="loading"?document.addEventListener("DOMContentLoaded",b,{once:!0}):setTimeout(b,100)}class T{constructor(e){this.params=e,this.user=y.getUser(),this.activeTab="list",this.followedAnimes=[],this.favoriteAnimes=[],this.stats={favs:0,list:0,epis:0}}async render(){if(!this.user)return window.location.href="/auth",document.createElement("div");this.followedAnimes=await E.following.toArray(),this.favoriteAnimes=await E.favorites.toArray(),this.stats={favs:this.favoriteAnimes.length,list:this.followedAnimes.length,epis:await E.history.count()};const e=document.createElement("div");return e.className="page-container",e.innerHTML=`
    ...
    `,e}async afterRender(){const e=document.getElementById("profile-tab-content"),i=document.querySelectorAll(".tab-btn-v5"),l=async t=>{if(this.activeTab=t,i.forEach(s=>s.classList.toggle("active",s.dataset.tab===t)),t==="list"){let a=function(o){if(!o||!o.day||!o.time||!o.timezone)return null;const r={Sundays:0,Mondays:1,Tuesdays:2,Wednesdays:3,Thursdays:4,Fridays:5,Saturdays:6}[o.day];if(r===void 0)return null;const[n,u]=o.time.split(":").map(Number),f=new Date(new Date().toLocaleString("en-US",{timeZone:o.timezone}));let m=new Date(f);m.setHours(n,u,0,0);let p=r-f.getDay();(p<0||p===0&&m<f)&&(p+=7),m.setDate(m.getDate()+p);const v=m-f;if(v<=0)return null;const A=Math.floor(v/(1e3*60*60*24)),w=Math.floor(v/(1e3*60*60)%24);return A>0?`${A}d ${w}h para nuevo cap.`:w>0?`${w}h para nuevo cap.`:"¡Nuevo cap en breve!"};e.innerHTML='<div class="grid-v5" id="grid-follow"></div>';const s=document.getElementById("grid-follow");this.followedAnimes.length>0?this.followedAnimes.forEach(o=>{const c=document.createElement("anime-card"),r={mal_id:o.animeId,title:o.title,images:{jpg:{large_image_url:o.cover}}};c.data=r,s.appendChild(c),Promise.all([g(async()=>{const{db:n}=await import("./page-homepage-BCn5ETVD.js").then(u=>u.e);return{db:n}},__vite__mapDeps([0,1])).then(({db:n})=>n.history.where("animeId").equals(String(o.animeId)).reverse().sortBy("timestamp")),g(async()=>{const{apiService:n}=await import("./page-homepage-BCn5ETVD.js").then(u=>u.f);return{apiService:n}},__vite__mapDeps([0,1])).then(({apiService:n})=>n.getAnimeInfo(o.animeId))]).then(([n,u])=>{let f={...r};if(n&&n.length>0&&(f.currentEpisode=n[0].episodeId),u&&u.data)if(u.data.status==="Currently Airing"){const m=a(u.data.broadcast);m&&(f.nextEpisodeText=m),f.status="EN EMISIÓN"}else u.data.status==="Finished Airing"&&(f.status="FINALIZADO");c.data=f})}):e.innerHTML='<p style="color:var(--text-muted)">Tu lista de seguimiento está vacía.</p>'}if(t==="favs"){e.innerHTML='<div class="grid-v5" id="grid-favs"></div>';const s=document.getElementById("grid-favs");this.favoriteAnimes.length>0?this.favoriteAnimes.forEach(a=>{const o=document.createElement("anime-card"),c={mal_id:a.animeId,title:a.title,images:{jpg:{large_image_url:a.cover}},status:a.status,broadcast:a.broadcast};o.data=c,s.appendChild(o),g(async()=>{const{apiService:r}=await import("./page-homepage-BCn5ETVD.js").then(n=>n.f);return{apiService:r}},__vite__mapDeps([0,1])).then(({apiService:r})=>{r.getAnimeInfo(a.animeId).then(n=>{n&&n.data&&(o.data={...c,status:n.data.status,broadcast:n.data.broadcast,episodes:n.data.episodes,score:n.data.score})})})}):e.innerHTML='<p style="color:var(--text-muted)">Aún no tienes favoritos.</p>'}if(t==="settings"){const s=await h.getSetting("theme","dark"),a=await h.getSetting("audio_pref","sub");e.innerHTML=`
        ...
        `,document.getElementById("audio-pref").addEventListener("change",async o=>await h.setSetting("audio_pref",o.target.value)),document.getElementById("theme-pref").addEventListener("change",async o=>{const c=o.target.value;await h.setSetting("theme",c),document.body.classList.toggle("light-theme",c==="light")}),document.getElementById("tv-mode-pref").addEventListener("change",o=>{const c=o.target.value==="on";c?x.init():x.destroy();const r=document.getElementById("header-tv-toggle");r&&(c?(r.classList.add("active"),r.style.background="rgba(255, 0, 85, 0.2)",r.style.boxShadow="0 0 15px rgba(255, 0, 85, 0.4)",r.style.border="1px solid rgba(255, 0, 85, 0.4)"):(r.classList.remove("active"),r.style.background="rgba(255,255,255,0.05)",r.style.boxShadow="none",r.style.border="none"))}),document.getElementById("sync-btn").addEventListener("click",async o=>{o.target.textContent="Procesando...";const c=await h.getAllData();await y.syncWithServer(c),window.location.reload()}),document.getElementById("reset-db-btn").addEventListener("click",async o=>{if(confirm("¿Estás seguro de que deseas restablecer la base de datos local? Tu historial y favoritos se descargarán de nuevo de la nube de forma limpia.")){o.target.textContent="Restableciendo...";try{await(await g(async()=>{const{default:r}=await import("./vendor-DIPEJTOH.js").then(n=>n.d);return{default:r}},[])).default.delete("AniRD_DB"),window.location.reload()}catch(c){alert("Error al restablecer la base de datos: "+c.message),window.location.reload()}}}),document.getElementById("logout-btn").addEventListener("click",()=>y.logout())}};i.forEach(t=>{t.addEventListener("click",()=>l(t.dataset.tab))});const d=document.getElementById("sync-btn-profile-mobile");d&&d.addEventListener("click",async()=>{const t=d.innerHTML;d.innerHTML="Sincronizando...";try{const s=await h.getAllData();await y.syncWithServer(s),d.innerHTML="¡Sincronizado con éxito!",setTimeout(()=>{window.location.reload()},1500)}catch(s){d.innerHTML=`Error: ${s.message}`,setTimeout(()=>{d.innerHTML=t},3e3)}}),await l("list")}}const _=Object.freeze(Object.defineProperty({__proto__:null,default:T},Symbol.toStringTag,{value:"Module"}));export{_ as P,x as s};
