const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-homepage-ENQx0n2_.js","assets/vendor-DIPEJTOH.js","assets/page-animedetailpage-B7uJmDiZ.js","assets/page-historypage-CejfwiS7.js","assets/page-favoritespage-C0cCUPx3.js","assets/page-searchpage-DAAprzeG.js","assets/page-categorypage-BThHObZ-.js","assets/page-calendarpage-Bkv3_ce0.js","assets/page-authpage-BJoKylPR.js","assets/page-profilepage-DzF-LOrV.js"])))=>i.map(i=>d[i]);
import{a as C,d as T,b as x}from"./page-homepage-ENQx0n2_.js";import{c as $}from"./vendor-DIPEJTOH.js";const P="modulepreload",k=function(y){return"/"+y},R={},I=function(e,t,s){let i=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),a=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));i=Promise.allSettled(t.map(l=>{if(l=k(l),l in R)return;R[l]=!0;const u=l.endsWith(".css"),r=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${r}`))return;const m=document.createElement("link");if(m.rel=u?"stylesheet":P,u||(m.as="script"),m.crossOrigin="",m.href=l,a&&m.setAttribute("nonce",a),document.head.appendChild(m),u)return new Promise((E,b)=>{m.addEventListener("load",E),m.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(n){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=n,window.dispatchEvent(a),!a.defaultPrevented)throw n}return i.then(n=>{for(const a of n||[])a.status==="rejected"&&o(a.reason);return e().catch(o)})},M=$(y=>({theme:"dark",isDataSaver:!1,setTheme:e=>y({theme:e}),toggleDataSaver:()=>y(e=>({isDataSaver:!e.isDataSaver})),currentRoute:"/",setCurrentRoute:e=>y({currentRoute:e}),isSearchOpen:!1,setSearchOpen:e=>y({isSearchOpen:e})})),S={"/":()=>I(()=>import("./page-homepage-ENQx0n2_.js").then(y=>y.H),__vite__mapDeps([0,1])),"/anime":()=>I(()=>import("./page-animedetailpage-B7uJmDiZ.js"),__vite__mapDeps([2,0,1])),"/watch":()=>I(()=>Promise.resolve().then(()=>W),void 0),"/history":()=>I(()=>import("./page-historypage-CejfwiS7.js"),__vite__mapDeps([3,0,1])),"/favorites":()=>I(()=>import("./page-favoritespage-C0cCUPx3.js"),__vite__mapDeps([4,0,1])),"/search":()=>I(()=>import("./page-searchpage-DAAprzeG.js"),__vite__mapDeps([5,0,1])),"/category":()=>I(()=>import("./page-categorypage-BThHObZ-.js"),__vite__mapDeps([6,0,1])),"/calendar":()=>I(()=>import("./page-calendarpage-Bkv3_ce0.js"),__vite__mapDeps([7,0,1])),"/my-anird":()=>I(()=>import("./page-historypage-CejfwiS7.js"),__vite__mapDeps([3,0,1])),"/auth":()=>I(()=>import("./page-authpage-BJoKylPR.js"),__vite__mapDeps([8,0,1])),"/profile":()=>I(()=>import("./page-profilepage-DzF-LOrV.js").then(y=>y.P),__vite__mapDeps([9,0,1]))};class B{constructor(e){this.root=e,this.init()}init(){window.addEventListener("popstate",()=>this.handleRoute()),document.body.addEventListener("click",e=>{const t=e.target.closest("a[data-link]");t&&(e.preventDefault(),this.navigate(t.getAttribute("href")))}),this.handleRoute()}navigate(e){window.history.pushState(null,null,e),this.handleRoute()}async handleRoute(){const e=new URL(window.location.href),t=e.pathname;let s="/",i={};const o={popular:"Animes Populares",movies:"Películas",latest:"Últimos Lanzamientos",dub:"Anime Latino",action:"Acción",comedy:"Comedia",romance:"Romance",supernatural:"Sobrenatural",adventure:"Aventura",drama:"Drama",fantasy:"Fantasía",music:"Musical","sci-fi":"Ciencia Ficción",seinen:"Seinen",shoujo:"Shoujo",shounen:"Shounen","slice-of-life":"Recuentos de la Vida",sports:"Deportes",thriller:"Thriller"};if(t.startsWith("/anime/"))s="/anime",i.id=t.split("/")[2],document.title="Cargando... — AniRD";else if(t.startsWith("/watch/")){s="/watch";const r=t.split("/");i.id=r[2],i.ep=r[3],i.lang=r[4]||"sub",document.title=`Ep. ${i.ep} — AniRD`}else t.startsWith("/category/")?(s="/category",i.name=t.split("/")[2],document.title=`${o[i.name]||"Explorar"} — AniRD`):t==="/search"?(s="/search",i.q=e.searchParams.get("q"),document.title=`Buscar "${i.q||""}" — AniRD`):t==="/profile"?(s="/profile",document.title="Mi Perfil — AniRD"):t==="/auth"?(s="/auth",document.title="Iniciar Sesión — AniRD"):t==="/calendar"?(s="/calendar",document.title="Calendario — AniRD"):t==="/history"||t==="/my-anird"?(s=S[t]?t:"/",document.title="Mi Historial — AniRD"):t==="/favorites"?(s="/favorites",document.title="Favoritos — AniRD"):(S[t]&&(s=t),document.title="AniRD — Tu plataforma de anime");const n=[];for(let r=0;r<document.body.classList.length;r++){const m=document.body.classList[r];m&&m.startsWith("route-")&&n.push(m)}n.forEach(r=>document.body.classList.remove(r));const a=`route-${s.replace("/","")||"home"}`;document.body.classList.add(a),M.getState().setCurrentRoute(t);const l=S[s]||S["/"];this.root.innerHTML=`
    ...
    `;let u;try{u=await l()}catch(r){console.warn("⚠️ Error al cargar componente de ruta, reintentando en 500ms...",r),await new Promise(m=>setTimeout(m,500));try{u=await l()}catch(m){console.error("❌ Fallo crítico al cargar ruta después de reintentar:",m),this.root.innerHTML=`
        ...
        `;return}}try{const r=u.default,m=new r(i);this.root.innerHTML="",this.root.appendChild(await m.render()),m.afterRender&&m.afterRender(),s==="/"&&(typeof window.requestIdleCallback=="function"?window.requestIdleCallback(()=>{S["/anime"]().catch(()=>{}),S["/watch"]().catch(()=>{})}):setTimeout(()=>{S["/anime"]().catch(()=>{}),S["/watch"]().catch(()=>{})},1500)),window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0}catch(r){console.error("Error al inicializar o renderizar la página:",r),this.root.innerHTML=`<div style="padding: 100px; text-align: center; color: red; font-family:'Outfit';"><h3>Error al renderizar el contenido</h3></div>`}}}let D=null;const N=y=>(!D&&y&&(D=new B(y)),D);class O{constructor(e){this.params=e,this.animeId=parseInt(e.id),this.episodeNum=parseInt(e.ep)||1,this.lang=e.lang||"sub",this.anime=null,this.localInfo=null,this.episodeData=null,this.relatedAnimes=[],this.anilistEpisodes=[],this.isFav=!1,this.watchedEpisodes=new Set,this.isTheater=localStorage.getItem("watch-theater-mode")==="true",this.sortDesc=!1,this.searchQuery=""}async render(){var l,u,r,m,E,b;try{console.log("Iniciando carga de WatchPage Premium para ID:",this.animeId,"Episodio:",this.episodeNum);const h=await C.getAnimeInfo(this.animeId);h&&h.data&&(this.anime=h.data);const p=new URLSearchParams(window.location.search).get("title"),v=[];if(this.anime&&(v.push(this.anime.title),this.anime.title_english&&v.push(this.anime.title_english),this.anime.title_japanese&&v.push(this.anime.title_japanese),this.anime.title_synonyms&&v.push(...this.anime.title_synonyms)),p&&!v.includes(p)&&v.push(p),v.length>0){let d=null;for(const f of v){const w=await C.searchLocal(f);if(w&&w.success&&w.data&&w.data.results&&w.data.results.length>0){d=w;break}}if(d){const f=d.data.results.find(_=>v.some(L=>_.title.toLowerCase().includes(L.toLowerCase())))||d.data.results[0];this.anime||(this.anime={title:f.title,images:{jpg:{large_image_url:f.thumbnail}},genres:[],synopsis:"Cargado desde el servidor local de AniRD."});const w=await C.getAnimeInfo(f.url);if(w.success){this.localInfo=w.data;const _=this.localInfo.episodes.find(L=>L.number===this.episodeNum);if(_&&_.url){const L=await C.getEpisode(_.url);if(L.success&&L.data){this.episodeData=L.data;const A=this.episodeData.servers[this.lang]||this.episodeData.servers.sub||[];this.episodeData.activeServers=A}}}}}this.isFav=await T.isFavorite(this.animeId);const g=await x.history.where({animeId:String(this.animeId)}).toArray();this.watchedEpisodes=new Set(g.map(d=>Number(d.episodeId)))}catch(h){console.error("Error crítico al renderizar WatchPage Premium:",h)}const e=document.createElement("div");if(e.className="page-enter",!this.anime)return e.innerHTML=`
      ...
      `,e;document.title=`${this.anime.title} — Episodio ${this.episodeNum} (${this.lang.toUpperCase()}) — AniRD`;const t=this.watchedEpisodes.has(this.episodeNum),s=`https://anilist.co/search/anime?search=${encodeURIComponent(this.anime.title)}`,i=`https://myanimelist.net/anime/${this.anime.mal_id||""}`,o=((u=(l=this.anime.images)==null?void 0:l.jpg)==null?void 0:u.large_image_url)||"",n=((m=(r=this.anime.images)==null?void 0:r.jpg)==null?void 0:m.large_image_url)||o;let a="";if(this.anime.status==="Currently Airing"&&this.anime.broadcast&&this.anime.broadcast.time){const h=this.anime.broadcast,c={Sundays:0,Mondays:1,Tuesdays:2,Wednesdays:3,Thursdays:4,Fridays:5,Saturdays:6};if(c[h.day]!==void 0){const[p,v]=h.time.split(":").map(Number),g=new Date(new Date().toLocaleString("en-US",{timeZone:h.timezone||"Asia/Tokyo"}));let d=new Date(g);d.setHours(p,v,0,0);let f=c[h.day]-g.getDay();(f<0||f===0&&d<g)&&(f+=7),d.setDate(d.getDate()+f),d-g>0&&(a=`
    ...
    `,e}async afterRender(){if(this._initPlayerControls(),this._initServerPills(),this._initSynopsisExpand(),this._initWatchedToggleControls(),this._loadEnrichedEpisodesAndRecommendations(),window.activeWatchInterval&&(clearInterval(window.activeWatchInterval),window.activeWatchInterval=null),this.anime){const t=this.watchedEpisodes.has(this.episodeNum),s=document.getElementById("btn-watched-status"),i=document.getElementById("watched-status-text");t?(s&&s.classList.add("active"),i&&(i.textContent="Visto")):(s&&s.classList.remove("active"),i&&(i.textContent="Marcar Visto"),this.watchTimeCounter=0,window.activeWatchInterval=setInterval(async()=>{var n,a;if(!document.getElementById("watch-layout")){document.body.classList.remove("tv-fullscreen-active"),document.body.classList.remove("mobile-fullscreen-active"),clearInterval(window.activeWatchInterval),window.activeWatchInterval=null;return}if(!document.hidden&&(this.watchTimeCounter++,this.watchTimeCounter>=120)){clearInterval(window.activeWatchInterval),window.activeWatchInterval=null,console.log("[WatchTimer] 2 minutos cumplidos. Marcando como visto automáticamente.");const l=this.anime?{animeTitle:this.anime.title,animeCover:((a=(n=this.anime.images)==null?void 0:n.jpg)==null?void 0:a.large_image_url)||this.anime.cover||"",animeType:this.anime.type||"",animeScore:this.anime.score||""}:{};await T.addToHistory(String(this.animeId),this.episodeNum,120,120,l),this.watchedEpisodes.add(this.episodeNum),s&&s.classList.add("active"),i&&(i.textContent="Visto"),this.renderEpisodes&&this.renderEpisodes()}},1e3))}const e=document.getElementById("btn-close-mobile-fs");e&&e.addEventListener("click",t=>{t.preventDefault(),t.stopPropagation();const s=document.getElementById("video-container");if(s){s.classList.remove("mobile-fullscreen-active"),document.body.classList.remove("mobile-fullscreen-active");const i=document.getElementById("btn-fullscreen-watch"),o=i?i.querySelector("span"):null;o&&(o.textContent="Pantalla Completa")}}),this._globalKeyHandler=t=>{if(!document.getElementById("watch-layout")){document.body.classList.remove("tv-fullscreen-active"),document.body.classList.remove("mobile-fullscreen-active"),window.removeEventListener("keydown",this._globalKeyHandler,{capture:!0});return}if(t.key==="Escape"||t.key==="Backspace"){const i=document.getElementById("video-container");if(i&&i.classList.contains("mobile-fullscreen-active")){i.classList.remove("mobile-fullscreen-active"),document.body.classList.remove("mobile-fullscreen-active");const o=document.getElementById("btn-fullscreen-watch"),n=o?o.querySelector("span"):null;n&&(n.textContent="Pantalla Completa"),t.preventDefault(),t.stopPropagation()}}},window.addEventListener("keydown",this._globalKeyHandler,{capture:!0})}_getAutoplayUrl(e){if(!e)return"";if(!(document.body.classList.contains("tv-mode")||localStorage.getItem("tvMode")==="true"))return e;try{const s=e.startsWith("//"),i=s?"https:"+e:e,o=new URL(i);o.searchParams.set("autoplay","1"),o.searchParams.set("auto","1");let n=o.toString();return s&&(n=n.replace(/^https:/,"")),n}catch{const i=e.includes("?")?"&":"?";return`${e}${i}autoplay=1&auto=1`}}_initPlayerControls(){const e=document.getElementById("watch-layout"),t=document.getElementById("player-section"),s=document.getElementById("main-column"),i=document.getElementById("dim-overlay"),o=document.getElementById("btn-theater"),n=document.getElementById("btn-lights"),a=document.getElementById("btn-favorite"),l=document.getElementById("lights-text"),u=document.getElementById("theater-text"),r=document.getElementById("fav-text"),m=c=>{if(document.body.classList.contains("tv-mode")||localStorage.getItem("tvMode")==="true"){e.classList.remove("theater-active"),t.parentElement!==e&&e.insertBefore(t,e.firstChild);return}c?(e.classList.add("theater-active"),e.insertBefore(t,e.firstChild),u&&(u.textContent="Modo Normal")):(e.classList.remove("theater-active"),s.insertBefore(t,s.firstChild),u&&(u.textContent="Modo Cine"))};m(this.isTheater),o&&o.addEventListener("click",()=>{this.isTheater=!this.isTheater,localStorage.setItem("watch-theater-mode",this.isTheater),o.classList.toggle("active",this.isTheater),m(this.isTheater)});const E=c=>{const p=c!==void 0?c:!i.classList.contains("active");i.classList.toggle("active",p),t.classList.toggle("dimmed-active",p),n.classList.toggle("active",p),l&&(l.textContent=p?"Encender Luces":"Apagar Luces")};n&&n.addEventListener("click",()=>E()),i&&i.addEventListener("click",()=>E(!1)),a&&a.addEventListener("click",async()=>{if(!this.anime)return;const c=await T.toggleFavorite(this.anime);this.isFav=c,a.classList.toggle("active",c),r&&(r.textContent=c?"Quitar Favorito":"Favorito")});const b=document.getElementById("btn-back-watch");b&&b.addEventListener("click",c=>{c.preventDefault(),window.history.back()});const h=document.getElementById("btn-fullscreen-watch");h&&h.addEventListener("click",c=>{c.preventDefault();const p=document.body.classList.contains("tv-mode")||localStorage.getItem("tvMode")==="true",v=window.innerWidth<=900||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),g=document.getElementById("video-container");if(g)if(p){document.body.classList.toggle("tv-fullscreen-active");const d=document.body.classList.contains("tv-fullscreen-active");g.classList.toggle("tv-fullscreen-active",d);const f=h.querySelector("span");f&&(f.textContent=d?"Salir Pantalla":"Pantalla Completa")}else if(v){document.body.classList.toggle("mobile-fullscreen-active");const d=document.body.classList.contains("mobile-fullscreen-active");g.classList.toggle("mobile-fullscreen-active",d);const f=h.querySelector("span");f&&(f.textContent=d?"Salir Pantalla":"Pantalla Completa")}else{const d=document.querySelector(".video-wrapper-v5 iframe");d&&(d.requestFullscreen?d.requestFullscreen():d.webkitRequestFullscreen?d.webkitRequestFullscreen():d.mozRequestFullScreen?d.mozRequestFullScreen():d.msRequestFullscreen&&d.msRequestFullscreen())}})}_initServerPills(){const e=document.querySelectorAll(".server-pill-v5"),t=document.querySelector(".video-wrapper-v5 iframe");e.forEach(i=>{i.addEventListener("click",o=>{e.forEach(a=>a.classList.remove("active")),i.classList.add("active");const n=i.getAttribute("data-url");if(t&&n){t.src=this._getAutoplayUrl(n);const a=document.getElementById("video-container");a.style.opacity="0.5",setTimeout(()=>a.style.opacity="1",500)}})}),document.querySelectorAll(".lang-pill-v5").forEach(i=>{i.addEventListener("click",o=>{const n=i.getAttribute("data-lang"),a=`/watch/${this.animeId}/${this.episodeNum}/${n}?title=${this.anime?encodeURIComponent(this.anime.title):""}`,l=N();l?l.navigate(a):window.location.href=a})})}_initSynopsisExpand(){const e=document.getElementById("synopsis-box"),t=document.getElementById("btn-more-synopsis");t&&e&&t.addEventListener("click",()=>{const s=e.classList.toggle("expanded");t.textContent=s?"... ver menos":"... ver más"})}_startCountdownTimer(e,t){let s=e-t;const i=setInterval(()=>{const o=document.getElementById("countdown-timer");if(!o){clearInterval(i);return}if(s-=1e3,s<=0){o.textContent="¡Disponible ya en Emisión!",clearInterval(i);return}const n=Math.floor(s/864e5),a=Math.floor(s%864e5/36e5),l=Math.floor(s%36e5/6e4),u=Math.floor(s%6e4/1e3);let r="";n>0&&(r+=`${n}d `),(a>0||n>0)&&(r+=`${a}h `),r+=`${l}m ${u}s`,o.textContent=r},1e3)}async _loadEnrichedEpisodesAndRecommendations(){var o,n;const e=document.getElementById("related-grid"),t=document.getElementById("sidebar-ep-list"),[s,i]=await Promise.all([C.getAnimeRecommendations(this.animeId).catch(()=>null),C.getAnilistEpisodes(this.animeId).catch(()=>[])]);if(e)if(s&&s.data&&s.data.length>0){const a=s.data.slice(0,6);e.innerHTML=a.map(l=>{var u,r;return`
        ...
        `}).join("")}else e.innerHTML='<p style="color:var(--text-muted); font-size:12px; font-weight:600;">No hay recomendaciones similares disponibles.</p>';if(this.localInfo&&this.localInfo.episodes){const a=this.localInfo.episodes,l=((n=(o=this.anime.images)==null?void 0:o.jpg)==null?void 0:n.large_image_url)||"",u=this.anime.title,r=()=>{let b=[...a];if(this.sortDesc&&b.reverse(),this.searchQuery.trim()!==""&&(b=b.filter(c=>String(c.number).includes(this.searchQuery)||c.title&&c.title.toLowerCase().includes(this.searchQuery.toLowerCase()))),b.length===0){t.innerHTML='<p style="color:var(--text-muted); text-align:center; padding:20px; font-size:11px;">No se encontraron episodios.</p>';return}t.innerHTML=b.map(c=>{let p=`Episodio ${c.number}`,v=l;const g=i[c.number-1];if(g&&(g.title&&(p=g.title.replace(/^Episode \d+\s*-?\s*/i,"")),g.thumbnail&&(v=g.thumbnail)),c.number===this.episodeNum){const A=document.getElementById("active-episode-title");A&&(A.textContent=`${this.anime.title} — ${p}`)}const d=c.number===this.episodeNum,f=this.watchedEpisodes.has(c.number),w=`/watch/${this.animeId}/${c.number}/${this.lang}?title=${encodeURIComponent(u)}`,_=f?'<div class="ep-watched-badge-v5">✓ Visto</div>':"",L=f?'<div class="ep-progress-bar-v5"><div class="ep-progress-fill-v5"></div></div>':"";return`
          ...
          `}).join("");const h=document.getElementById("btn-watched-all");if(h&&this.localInfo&&this.localInfo.episodes){const p=this.localInfo.episodes.map(v=>v.number).every(v=>this.watchedEpisodes.has(v));h.classList.toggle("active",p),h.title=p?"Desmarcar toda la temporada":"Marcar toda la temporada como vista"}};this.renderEpisodes=r,r();const m=document.getElementById("ep-search-input");m&&m.addEventListener("input",b=>{this.searchQuery=b.target.value,r()});const E=document.getElementById("btn-sort-ep");E&&E.addEventListener("click",()=>{this.sortDesc=!this.sortDesc,E.classList.toggle("active",this.sortDesc),r()})}else t&&(t.innerHTML=`
        ...
        `)}_initWatchedToggleControls(){const e=document.getElementById("btn-watched-status"),t=document.getElementById("watched-status-text"),s=document.getElementById("btn-watched-all");e&&e.addEventListener("click",async()=>{var o,n;const i=this.watchedEpisodes.has(this.episodeNum);if(window.activeWatchInterval&&(clearInterval(window.activeWatchInterval),window.activeWatchInterval=null),i){const a=await x.history.where({animeId:String(this.animeId),episodeId:this.episodeNum}).first();a&&await x.history.delete(a.id),this.watchedEpisodes.delete(this.episodeNum),e.classList.remove("active"),t&&(t.textContent="Marcar Visto"),await T.triggerSync()}else{const a=this.anime?{animeTitle:this.anime.title,animeCover:((n=(o=this.anime.images)==null?void 0:o.jpg)==null?void 0:n.large_image_url)||this.anime.cover||"",animeType:this.anime.type||"",animeScore:this.anime.score||""}:{};await T.addToHistory(String(this.animeId),this.episodeNum,120,120,a),this.watchedEpisodes.add(this.episodeNum),e.classList.add("active"),t&&(t.textContent="Visto")}this.renderEpisodes&&this.renderEpisodes()}),s&&s.addEventListener("click",async()=>{if(!this.localInfo||!this.localInfo.episodes)return;const o=this.localInfo.episodes.map(a=>a.number);if(window.activeWatchInterval&&(clearInterval(window.activeWatchInterval),window.activeWatchInterval=null),o.every(a=>this.watchedEpisodes.has(a)))await x.transaction("rw",x.history,async()=>{for(const a of o){const l=await x.history.where({animeId:String(this.animeId),episodeId:a}).first();l&&await x.history.delete(l.id)}}),o.forEach(a=>this.watchedEpisodes.delete(a)),this.watchedEpisodes.has(this.episodeNum)?(e&&e.classList.add("active"),t&&(t.textContent="Visto")):(e&&e.classList.remove("active"),t&&(t.textContent="Marcar Visto"));else{const a=Date.now();await x.transaction("rw",x.history,async()=>{for(const l of o)await x.history.where({animeId:String(this.animeId),episodeId:l}).first()||await x.history.add({animeId:String(this.animeId),episodeId:l,progress:120,duration:120,timestamp:a,updatedAt:a})}),o.forEach(l=>this.watchedEpisodes.add(l)),this.watchedEpisodes.has(this.episodeNum)?(e&&e.classList.add("active"),t&&(t.textContent="Visto")):(e&&e.classList.remove("active"),t&&(t.textContent="Marcar Visto"))}await T.triggerSync(),this.renderEpisodes&&this.renderEpisodes()})}}const W=Object.freeze(Object.defineProperty({__proto__:null,default:O},Symbol.toStringTag,{value:"Module"}));export{I as _,N as g,M as u};
