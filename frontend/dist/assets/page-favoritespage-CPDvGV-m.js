...
import{_ as s}from"./page-watchpage-CF4pbcAd.js";import{d}from"./page-homepage-gz9FGPn7.js";import"./vendor-DIPEJTOH.js";import"./page-animedetailpage-AOBgfgm5.js";import"./dependencies-Ce00LDPN.js";class x{async render(){const a=document.createElement("div");return a.innerHTML=`
    ...
    `,a}async afterRender(){const a=document.getElementById("favorites-grid"),o=await d.getFavorites();if(o.length===0){a.innerHTML=`
      ...
      `;return}a.innerHTML="",o.forEach(t=>{const i=document.createElement("anime-card"),n={mal_id:t.animeId,title:t.title,images:{jpg:{large_image_url:t.cover}},type:t.type,score:t.score,episodes:t.episodes,status:t.status,broadcast:t.broadcast};i.data=n,a.appendChild(i),s(async()=>{const{apiService:r}=await import("./page-homepage-gz9FGPn7.js").then(e=>e.f);return{apiService:r}},__vite__mapDeps([0,1])).then(({apiService:r})=>{r.getAnimeInfo(t.animeId).then(e=>{e&&e.data&&(i.data={...n,status:e.data.status,broadcast:e.data.broadcast,episodes:e.data.episodes,score:e.data.score})})})})}}export{x as default};
