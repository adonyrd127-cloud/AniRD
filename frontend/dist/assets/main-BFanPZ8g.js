const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-homepage-BLqD5dcZ.js","assets/vendor-Cmt3X8aB.js","assets/page-animedetailpage-Bpak1nFe.js","assets/page-watchpage-CzJ-y2lE.js","assets/page-historypage-BYT4hHTr.js","assets/page-favoritespage-B_Ku10Wz.js","assets/page-searchpage-CqmFO20d.js","assets/page-categorypage-BpEqEWR7.js","assets/page-calendarpage-Bij_2Qoz.js","assets/page-authpage-B004jQin.js","assets/page-profilepage-CaUwlo7t.js"])))=>i.map(i=>d[i]);
import{_ as d}from"./page-favoritespage-B_Ku10Wz.js";import{c as w}from"./vendor-Cmt3X8aB.js";import{a as k,b as c,d as v}from"./page-homepage-BLqD5dcZ.js";import{a as m}from"./page-authpage-B004jQin.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const E=w(i=>({theme:"dark",isDataSaver:!1,setTheme:e=>i({theme:e}),toggleDataSaver:()=>i(e=>({isDataSaver:!e.isDataSaver})),currentRoute:"/",setCurrentRoute:e=>i({currentRoute:e}),isSearchOpen:!1,setSearchOpen:e=>i({isSearchOpen:e})})),u={"/":()=>d(()=>import("./page-homepage-BLqD5dcZ.js").then(i=>i.H),__vite__mapDeps([0,1])),"/anime":()=>d(()=>import("./page-animedetailpage-Bpak1nFe.js"),__vite__mapDeps([2,0,1])),"/watch":()=>d(()=>import("./page-watchpage-CzJ-y2lE.js"),__vite__mapDeps([3,0,1])),"/history":()=>d(()=>import("./page-historypage-BYT4hHTr.js"),__vite__mapDeps([4,0,1])),"/favorites":()=>d(()=>import("./page-favoritespage-B_Ku10Wz.js").then(i=>i.F),__vite__mapDeps([5,0,1])),"/search":()=>d(()=>import("./page-searchpage-CqmFO20d.js"),__vite__mapDeps([6,0,1])),"/category":()=>d(()=>import("./page-categorypage-BpEqEWR7.js"),__vite__mapDeps([7,0,1])),"/calendar":()=>d(()=>import("./page-calendarpage-Bij_2Qoz.js"),__vite__mapDeps([8,0,1])),"/my-anird":()=>d(()=>import("./page-historypage-BYT4hHTr.js"),__vite__mapDeps([4,0,1])),"/auth":()=>d(()=>import("./page-authpage-B004jQin.js").then(i=>i.A),__vite__mapDeps([9,0,1])),"/profile":()=>d(()=>import("./page-profilepage-CaUwlo7t.js"),__vite__mapDeps([10,5,0,1,9]))};class L{constructor(e){this.root=e,this.init()}init(){window.addEventListener("popstate",()=>this.handleRoute()),document.body.addEventListener("click",e=>{const t=e.target.closest("a[data-link]");t&&(e.preventDefault(),this.navigate(t.getAttribute("href")))}),this.handleRoute()}navigate(e){window.history.pushState(null,null,e),this.handleRoute()}async handleRoute(){const e=new URL(window.location.href),t=e.pathname;let n="/",a={};const r={popular:"Animes Populares",movies:"Películas",latest:"Últimos Lanzamientos",dub:"Anime Latino",action:"Acción",comedy:"Comedia",romance:"Romance",supernatural:"Sobrenatural",adventure:"Aventura",drama:"Drama",fantasy:"Fantasía",music:"Musical","sci-fi":"Ciencia Ficción",seinen:"Seinen",shoujo:"Shoujo",shounen:"Shounen","slice-of-life":"Recuentos de la Vida",sports:"Deportes",thriller:"Thriller"};if(t.startsWith("/anime/"))n="/anime",a.id=t.split("/")[2],document.title="Cargando... — AniRD";else if(t.startsWith("/watch/")){n="/watch";const s=t.split("/");a.id=s[2],a.ep=s[3],a.lang=s[4]||"sub",document.title=`Ep. ${a.ep} — AniRD`}else t.startsWith("/category/")?(n="/category",a.name=t.split("/")[2],document.title=`${r[a.name]||"Explorar"} — AniRD`):t==="/search"?(n="/search",a.q=e.searchParams.get("q"),document.title=`Buscar "${a.q||""}" — AniRD`):t==="/profile"?(n="/profile",document.title="Mi Perfil — AniRD"):t==="/auth"?(n="/auth",document.title="Iniciar Sesión — AniRD"):t==="/calendar"?(n="/calendar",document.title="Calendario — AniRD"):t==="/history"||t==="/my-anird"?(n=u[t]?t:"/",document.title="Mi Historial — AniRD"):t==="/favorites"?(n="/favorites",document.title="Favoritos — AniRD"):(u[t]&&(n=t),document.title="AniRD — Tu plataforma de anime");E.getState().setCurrentRoute(t);const o=u[n]||u["/"];this.root.innerHTML='<div style="padding: 50px; text-align: center; color: white;">Cargando...</div>';try{const l=(await o()).default,h=new l(a);this.root.innerHTML="",this.root.appendChild(await h.render()),h.afterRender&&h.afterRender()}catch(s){console.error("Error loading route",s),this.root.innerHTML='<div style="padding: 50px; text-align: center; color: red;">Error al cargar la página</div>'}}}let f=null;const _=i=>(!f&&i&&(f=new L(i)),f);class A{constructor(e){this.router=e,this.timeout=null,this.render(),this.bindEvents()}render(){this.container=document.createElement("div"),this.container.className="search-overlay",this.container.id="searchOverlay",this.container.innerHTML=`
      <style>
        .search-overlay {
          position: fixed;
          inset: 0;
      ...
      `,this.timeout=setTimeout(async()=>{try{const a=((await k.getAnimeSearch(t)).data||[]).slice(0,8);a.length>0?(this.resultsContainer.innerHTML=`
              <div class="result-group">
                ...
                <div class="result-items">
                  ${a.map(r=>{var o,s;return`
                    <a href="/anime/${r.mal_id||r.id}" data-link class="result-item search-result-item">
                      <img src="${((s=(o=r.images)==null?void 0:o.jpg)==null?void 0:s.image_url)||r.image||""}" alt="" loading="lazy">
                      <div class="result-item-info">
          ...
          `}},400)}),this.input.addEventListener("keydown",e=>{if(e.key==="Enter"){const t=this.input.value.trim();t&&(this.close(),this.router.navigate(`/search?q=${encodeURIComponent(t)}`))}})}open(){this.container.classList.add("active"),this.input.focus()}close(){this.container.classList.remove("active"),this.input.value=""}}const p={async checkNewEpisodes(){const i=await c.following.toArray();let e=!1;for(const t of i)if(t.status==="Currently Airing"&&t.broadcast&&t.broadcast.day&&t.broadcast.day!=="Unknown"){const n=this.getLastBroadcast(t.broadcast);n&&(!t.lastNotified||n>t.lastNotified)&&(await c.notifications.where("animeId").equals(t.animeId).and(r=>r.timestamp===n).first()||(await c.notifications.add({animeId:t.animeId,isRead:0,timestamp:n}),e=!0),await c.following.update(t.animeId,{lastNotified:n}))}return e},getLastBroadcast(i){const e={Sundays:0,Mondays:1,Tuesdays:2,Wednesdays:3,Thursdays:4,Fridays:5,Saturdays:6};if(e[i.day]===void 0)return null;const[t,n]=i.time.split(":").map(Number),a=new Date(new Date().toLocaleString("en-US",{timeZone:i.timezone||"Asia/Tokyo"}));let r=new Date(a);r.setHours(t,n,0,0);let o=e[i.day]-a.getDay();(o<0||o===0&&r<=a)&&(o+=7),r.setDate(r.getDate()+o);const s=new Date(r);if(s.setDate(s.getDate()-7),s>a)return null;const l=s.getTime()-a.getTime();return Date.now()+l},async getUnreadCount(){return await c.notifications.where("isRead").equals(0).count()},async getNotifications(){const i=await c.notifications.orderBy("timestamp").reverse().toArray(),e=[];for(const t of i){const n=await c.following.get(t.animeId);n&&e.push({...t,title:n.title,cover:n.cover})}return e},async markAllAsRead(){await c.notifications.where("isRead").equals(0).modify({isRead:1})}},g=document.getElementById("app"),R=_(g),y=new A(R),x=document.createElement("header");x.innerHTML=`
...
`;document.body.insertBefore(x,g);const b=()=>{const i=document.getElementById("profile-link"),e=document.getElementById("mobile-profile-link"),t=m.isLoggedIn(),n=t?"/profile":"/auth",a=t?"Mi Perfil":"Entrar";if(i&&(i.setAttribute("href",n),i.textContent=a),e){e.setAttribute("href",n);const r=e.querySelector("span:last-child");r&&(r.textContent=a)}};window.updateNavbarAuth=b;b();document.getElementById("open-search-btn").addEventListener("click",()=>y.open());document.getElementById("mobile-search-btn").addEventListener("click",i=>{i.preventDefault(),y.open()});const D=async()=>{const i=document.getElementById("nav-notifications"),e=document.getElementById("notif-badge"),t=document.getElementById("notif-dropdown"),n=document.getElementById("notif-list"),a=document.getElementById("mark-read-btn");if(!i)return;const r=async()=>{await p.getUnreadCount()>0?(e.style.display="block",i.style.color="#ff0000"):(e.style.display="none",i.style.color="inherit")},o=async()=>{const s=await p.getNotifications();if(s.length===0){n.innerHTML='<div style="color:var(--text-muted); font-size:12px; text-align:center; padding: 20px 0;">No hay notificaciones nuevas</div>';return}n.innerHTML=s.map(l=>`
    ...
    `).join("")};i.addEventListener("click",async s=>{if(s.target===a)return;const l=t.style.display==="block";t.style.display=l?"none":"block",l||await o()}),a.addEventListener("click",async s=>{s.stopPropagation(),await p.markAllAsRead(),await r(),await o()}),document.addEventListener("click",s=>{i.contains(s.target)||(t.style.display="none")}),m.isLoggedIn()&&await p.checkNewEpisodes(),await r()},S=async()=>{if(await v.getSetting("theme","dark")==="light"&&document.body.classList.add("light-theme"),m.isLoggedIn())try{const e=await m.fetchFromServer();e&&await v.syncFromServer(e)}catch{console.error("Sync fail")}await D()};S();
