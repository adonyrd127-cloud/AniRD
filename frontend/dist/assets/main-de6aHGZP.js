import{g as A,u as T}from"./page-watchpage-EghyyxfU.js";import{a as M,b as d,d as f,c as u}from"./page-homepage-ENQx0n2_.js";import{s as c}from"./page-profilepage-8yXC_XHJ.js";import"./vendor-DIPEJTOH.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();class N{constructor(a){this.router=a,this.timeout=null,this.abortController=null,this.render(),this.bindEvents()}render(){this.container=document.createElement("div"),this.container.className="search-overlay",this.container.id="searchOverlay",this.container.innerHTML=`
      <style>
        .search-overlay {
          position: fixed;
          inset: 0;
    ...
    `,document.body.appendChild(this.container),this.input=this.container.querySelector("#palette-input"),this.resultsContainer=this.container.querySelector("#palette-results")}bindEvents(){document.addEventListener("keydown",a=>{(a.metaKey||a.ctrlKey)&&a.key==="k"&&(a.preventDefault(),this.open()),a.key==="Escape"&&this.container.classList.contains("active")&&this.close()}),this.container.addEventListener("click",a=>{a.target===this.container&&this.close()}),this.input.addEventListener("input",a=>{const t=a.target.value.trim();this.abortController&&this.abortController.abort(),this.abortController=new AbortController;const s=this.abortController.signal;if(t.length<3){this.resultsContainer.innerHTML=`
      ...
      `,this.timeout=setTimeout(async()=>{try{const i=await M.getAnimeSearch(t,{signal:s});if(s.aborted)return;const r=(i.data||[]).slice(0,8);r.length>0?(this.resultsContainer.innerHTML=`
              <div class="result-group">
                <h4>Animes</h4>
                <div class="result-items">
                  ${r.map(n=>{var o,l;return`
...
`;document.body.insertBefore(m,h);const C=()=>{const e=document.getElementById("profile-link"),a=document.getElementById("mobile-profile-link"),t=document.getElementById("sidebar-profile-link"),s=document.getElementById("profile-avatar-container"),i=document.getElementById("profile-username-text"),r=u.isLoggedIn(),n=u.getUser(),o=r?"/profile":"/auth";if(e&&(e.setAttribute("href",o),r?(s&&s.classList.add("active-border"),i&&(i.textContent=(n==null?void 0:n.username)||"Perfil")):(s&&s.classList.remove("active-border"),i&&(i.textContent="Entrar"))),a){a.setAttribute("href",o);const l=a.querySelector(".nav-label");l&&(l.textContent=r?"Perfil":"Entrar")}if(t){t.setAttribute("href",o);const l=t.querySelector("span");l&&(l.textContent=r?"Mi Perfil":"Entrar")}},B=e=>{const a=document.getElementById("bottomNav");if(!a)return;const t=a.querySelectorAll(".nav-item");t.forEach(i=>{i.classList.remove("active");const r=i.querySelector("svg");r&&r.setAttribute("stroke-width","1.8")});let s=-1;if(e==="/"||e.startsWith("/anime/")||e.startsWith("/category/")||e.startsWith("/watch/")||e==="/calendar"?s=0:e==="/favorites"?s=2:(e==="/profile"||e==="/auth")&&(s=3),s!==-1&&t[s]){t[s].classList.add("active");const i=t[s].querySelector("svg");i&&i.setAttribute("stroke-width","2.2")}},S=e=>{const a=document.querySelector(".desktop-sidebar");if(!a)return;a.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active"));let s="/";e==="/"||e.startsWith("/anime/")||e.startsWith("/watch/")||e.startsWith("/category/")||e==="/calendar"?s="/":e==="/favorites"?s="/favorites":e==="/history"||e==="/my-anird"?s="/history":(e==="/profile"||e==="/auth")&&(s="/profile");const i=a.querySelector(`.sidebar-link[data-route="${s}"]`);i&&i.classList.add("active")},I=async()=>{const e=document.getElementById("sidebar-following-list");if(e)try{const a=await f.getFollowing();if(a.length===0){e.innerHTML=`
    ...
    `).join("")};e.addEventListener("click",async o=>{if(o.target===i)return;const l=t.style.display==="block";t.style.display=l?"none":"block",l||await n()}),i.addEventListener("click",async o=>{o.stopPropagation(),await p.markAllAsRead(),await r(),await n()}),document.addEventListener("click",o=>{e.contains(o.target)||(t.style.display="none")}),u.isLoggedIn()&&await p.checkNewEpisodes(),await r()},q=()=>{const e=document.getElementById("tv-mode-toggle"),a=document.getElementById("tv-mode-text"),t=document.getElementById("header-tv-toggle"),s=o=>{a&&(a.textContent=o?"📺 Modo TV: ON":"📺 Modo TV: OFF"),e&&(o?e.classList.add("active"):e.classList.remove("active")),t&&(o?(t.classList.add("active"),t.style.background="rgba(255, 0, 85, 0.2)",t.style.boxShadow="0 0 15px rgba(255, 0, 85, 0.4)",t.style.border="1px solid rgba(255, 0, 85, 0.4)"):(t.classList.remove("active"),t.style.background="rgba(255,255,255,0.05)",t.style.boxShadow="none",t.style.border="none"))},i=()=>{c.isActive?(c.destroy(),s(!1)):(c.init(),s(!0))};e&&e.addEventListener("click",o=>{o.preventDefault(),i()}),t&&t.addEventListener("click",o=>{o.preventDefault(),i()});const r=localStorage.getItem("tvMode")==="true",n=/AniRD-AndroidTV|SmartTV|GoogleTV|AppleTV|HbbTV|LG NetCast|Opera TV|Tizen|Web0S|Nexus Player|AndroidTV|Roku|AFT|Silk|FireTV|Amazon|Chromecast|DroidTV|TV\s+Box|Smart_TV|MiBox|Shield/i.test(navigator.userAgent)||navigator.userAgent.toLowerCase().includes("tv");r||localStorage.getItem("tvMode")===null&&n?(c.init(),s(!0)):s(!1)},R=async()=>{let e=await f.getSetting("theme",null);if(e||(e=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),e==="light"?document.body.classList.add("light-theme"):document.body.classList.remove("light-theme"),u.isLoggedIn())try{const a=await u.fetchFromServer();a&&await f.syncFromServer(a)}catch{console.error("Sync fail")}await j(),setTimeout(q,200)};R();
