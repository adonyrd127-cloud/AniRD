const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-homepage-DgsCwRM0.js","assets/vendor-DIPEJTOH.js","assets/page-animedetailpage-DokqsIpM.js","assets/page-historypage-lU7gUM4v.js","assets/page-favoritespage-B9kEqQ-U.js","assets/page-searchpage-PqUEvGeu.js","assets/page-categorypage-DmKXnD79.js","assets/page-calendarpage-BLmTQeg8.js","assets/page-authpage-BQPaxz5C.js","assets/page-profilepage-5PpNggFp.js","assets/page-mylistspage-lPUB2Hsx.js"])))=>i.map(i=>d[i]);
import{a as D,d as _,b as I}from"./page-homepage-DgsCwRM0.js";import{c as P}from"./vendor-DIPEJTOH.js";import{T}from"./page-animedetailpage-DokqsIpM.js";const M="modulepreload",B=function(g){return"/"+g},$={},E=function(e,t,s){let a=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));a=Promise.allSettled(t.map(o=>{if(o=B(o),o in $)return;$[o]=!0;const m=o.endsWith(".css"),c=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${c}`))return;const u=document.createElement("link");if(u.rel=m?"stylesheet":M,m||(u.as="script"),u.crossOrigin="",u.href=o,i&&u.setAttribute("nonce",i),document.head.appendChild(u),m)return new Promise((x,b)=>{u.addEventListener("load",x),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function l(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return a.then(n=>{for(const i of n||[])i.status==="rejected"&&l(i.reason);return e().catch(l)})},O=P(g=>({theme:"dark",isDataSaver:!1,setTheme:e=>g({theme:e}),toggleDataSaver:()=>g(e=>({isDataSaver:!e.isDataSaver})),currentRoute:"/",setCurrentRoute:e=>g({currentRoute:e}),isSearchOpen:!1,setSearchOpen:e=>g({isSearchOpen:e})})),A={"/":()=>E(()=>import("./page-homepage-DgsCwRM0.js").then(g=>g.H),__vite__mapDeps([0,1])),"/anime":()=>E(()=>import("./page-animedetailpage-DokqsIpM.js").then(g=>g.A),__vite__mapDeps([2,0,1])),"/watch":()=>E(()=>Promise.resolve().then(()=>V),void 0),"/history":()=>E(()=>import("./page-historypage-lU7gUM4v.js"),__vite__mapDeps([3,0,1])),"/favorites":()=>E(()=>import("./page-favoritespage-B9kEqQ-U.js"),__vite__mapDeps([4,0,1,2])),"/search":()=>E(()=>import("./page-searchpage-PqUEvGeu.js"),__vite__mapDeps([5,0,1])),"/category":()=>E(()=>import("./page-categorypage-DmKXnD79.js"),__vite__mapDeps([6,0,1])),"/calendar":()=>E(()=>import("./page-calendarpage-BLmTQeg8.js"),__vite__mapDeps([7,0,1])),"/my-anird":()=>E(()=>import("./page-historypage-lU7gUM4v.js"),__vite__mapDeps([3,0,1])),"/auth":()=>E(()=>import("./page-authpage-BQPaxz5C.js"),__vite__mapDeps([8,0,1])),"/profile":()=>E(()=>import("./page-profilepage-5PpNggFp.js").then(g=>g.P),__vite__mapDeps([9,0,1])),"/lists":()=>E(()=>import("./page-mylistspage-lPUB2Hsx.js"),__vite__mapDeps([10,0,1,2]))};class N{constructor(e){this.root=e,this.init()}init(){window.addEventListener("popstate",()=>this.handleRoute()),document.body.addEventListener("click",e=>{const t=e.target.closest("a[data-link]");t&&(e.preventDefault(),this.navigate(t.getAttribute("href")))}),this.handleRoute()}navigate(e){window.history.pushState(null,null,e),this.handleRoute()}async handleRoute(){const e=new URL(window.location.href),t=e.pathname;let s="/",a={};const l={popular:"Animes Populares",movies:"Películas",latest:"Últimos Lanzamientos",dub:"Anime Latino",action:"Acción",comedy:"Comedia",romance:"Romance",supernatural:"Sobrenatural",adventure:"Aventura",drama:"Drama",fantasy:"Fantasía",music:"Musical","sci-fi":"Ciencia Ficción",seinen:"Seinen",shoujo:"Shoujo",shounen:"Shounen","slice-of-life":"Recuentos de la Vida",sports:"Deportes",thriller:"Thriller"};if(t.startsWith("/anime/"))s="/anime",a.id=t.split("/")[2],document.title="Cargando... — AniRD";else if(t.startsWith("/watch/")){s="/watch";const c=t.split("/");a.id=c[2],a.ep=c[3],a.lang=c[4]||"sub",document.title=`Ep. ${a.ep} — AniRD`}else t.startsWith("/category/")?(s="/category",a.name=t.split("/")[2],document.title=`${l[a.name]||"Explorar"} — AniRD`):t==="/search"?(s="/search",a.q=e.searchParams.get("q"),document.title=`Buscar "${a.q||""}" — AniRD`):t==="/profile"?(s="/profile",document.title="Mi Perfil — AniRD"):t==="/auth"?(s="/auth",document.title="Iniciar Sesión — AniRD"):t==="/calendar"?(s="/calendar",document.title="Calendario — AniRD"):t==="/history"||t==="/my-anird"?(s=A[t]?t:"/",document.title="Mi Historial — AniRD"):t==="/favorites"?(s="/favorites",document.title="Favoritos — AniRD"):t==="/lists"?(s="/lists",document.title="Mis Listas — AniRD"):(A[t]&&(s=t),document.title="AniRD — Tu plataforma de anime");const n=[];for(let c=0;c<document.body.classList.length;c++){const u=document.body.classList[c];u&&u.startsWith("route-")&&n.push(u)}n.forEach(c=>document.body.classList.remove(c));const i=`route-${s.replace("/","")||"home"}`;document.body.classList.add(i),O.getState().setCurrentRoute(t);const o=A[s]||A["/"];this.root.innerHTML=`
    ...
    `;let m;try{m=await o()}catch(c){console.warn("⚠️ Error al cargar componente de ruta, reintentando en 500ms...",c),await new Promise(u=>setTimeout(u,500));try{m=await o()}catch(u){console.error("❌ Fallo crítico al cargar ruta después de reintentar:",u),this.root.innerHTML=`
        ...
        `;return}}try{const c=m.default,u=new c(a);this.root.innerHTML="",this.root.appendChild(await u.render()),u.afterRender&&u.afterRender(),s==="/"&&(typeof window.requestIdleCallback=="function"?window.requestIdleCallback(()=>{A["/anime"]().catch(()=>{}),A["/watch"]().catch(()=>{})}):setTimeout(()=>{A["/anime"]().catch(()=>{}),A["/watch"]().catch(()=>{})},1500)),window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0}catch(c){console.error("Error al inicializar o renderizar la página:",c),this.root.innerHTML=`<div style="padding: 100px; text-align: center; color: red; font-family:'Outfit';"><h3>Error al renderizar el contenido</h3></div>`}}}let R=null;const W=g=>(!R&&g&&(R=new N(g)),R);class F{constructor(e){this.params=e,this.animeId=parseInt(e.id),this.episodeNum=parseInt(e.ep)||1,this.lang=e.lang||"sub",this.anime=null,this.localInfo=null,this.episodeData=null,this.relatedAnimes=[],this.anilistEpisodes=[],this.isFav=!1,this.watchedEpisodes=new Set,this.isTheater=localStorage.getItem("watch-theater-mode")==="true",this.sortDesc=!1,this.searchQuery=""}async render(){var o,m,c,u,x,b;try{console.log("Iniciando carga de WatchPage Premium para ID:",this.animeId,"Episodio:",this.episodeNum);const p=await D.getAnimeInfo(this.animeId);p&&p.data&&(this.anime=p.data);const h=new URLSearchParams(window.location.search).get("title"),v=[];if(this.anime&&(v.push(this.anime.title),this.anime.title_english&&v.push(this.anime.title_english),this.anime.title_japanese&&v.push(this.anime.title_japanese),this.anime.title_synonyms&&v.push(...this.anime.title_synonyms)),h&&!v.includes(h)&&v.push(h),v.length>0){let f=null;for(const r of v){const y=await D.searchLocal(r);if(y&&y.success&&y.data&&y.data.results&&y.data.results.length>0){f=y;break}}if(f){const r=f.data.results.find(C=>v.some(L=>C.title.toLowerCase().includes(L.toLowerCase())))||f.data.results[0];this.anime||(this.anime={title:r.title,images:{jpg:{large_image_url:r.thumbnail}},genres:[],synopsis:"Cargado desde el servidor local de AniRD."});const y=await D.getAnimeInfo(r.url);if(y.success){this.localInfo=y.data;const C=this.localInfo.episodes.find(L=>L.number===this.episodeNum);if(C&&C.url){const L=await D.getEpisode(C.url);if(L.success&&L.data){this.episodeData=L.data;let S=this.episodeData.servers[this.lang];if(!S||S.length===0)if(this.lang==="dub"&&this.episodeData.servers.sub&&this.episodeData.servers.sub.length>0){this.lang="sub",S=this.episodeData.servers.sub,T.show("El episodio no tiene doblaje disponible. Reproduciendo subtitulado.","info");const k=window.location.href.replace("/dub","/sub");window.history.replaceState({},"",k)}else S=this.episodeData.servers.sub||[];this.episodeData.activeServers=S}}}}}this.isFav=await _.isFavorite(this.animeId);const w=await I.history.where({animeId:String(this.animeId)}).toArray();this.watchedEpisodes=new Set(w.map(f=>Number(f.episodeId)))}catch(p){console.error("Error crítico al renderizar WatchPage Premium:",p)}const e=document.createElement("div");if(e.className="page-enter",!this.anime)return e.innerHTML=`
