...
import{_ as d}from"./page-favoritespage-BsIX1kVp.js";import{c as D}from"./vendor-DIPEJTOH.js";import{a as T,b as c,d as y,c as u}from"./page-homepage-HfrhAw2J.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function i(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(a){if(a.ep)return;a.ep=!0;const s=i(a);fetch(a.href,s)}})();const S=D(t=>({theme:"dark",isDataSaver:!1,setTheme:e=>t({theme:e}),toggleDataSaver:()=>t(e=>({isDataSaver:!e.isDataSaver})),currentRoute:"/",setCurrentRoute:e=>t({currentRoute:e}),isSearchOpen:!1,setSearchOpen:e=>t({isSearchOpen:e})})),p={"/":()=>d(()=>import("./page-homepage-HfrhAw2J.js").then(t=>t.H),__vite__mapDeps([0,1])),"/anime":()=>d(()=>import("./page-animedetailpage-BoYs1ihs.js"),__vite__mapDeps([2,0,1])),"/watch":()=>d(()=>import("./page-watchpage-CgQp7min.js"),__vite__mapDeps([3,0,1])),"/history":()=>d(()=>import("./page-historypage-CqZNK3jg.js"),__vite__mapDeps([4,0,1])),"/favorites":()=>d(()=>import("./page-favoritespage-BsIX1kVp.js").then(t=>t.F),__vite__mapDeps([5,0,1])),"/search":()=>d(()=>import("./page-searchpage-bBXt4b5Y.js"),__vite__mapDeps([6,0,1])),"/category":()=>d(()=>import("./page-categorypage-BQusQMjN.js"),__vite__mapDeps([7,0,1])),"/calendar":()=>d(()=>import("./page-calendarpage-Dcd-pGqP.js"),__vite__mapDeps([8,0,1])),"/my-anird":()=>d(()=>import("./page-historypage-CqZNK3jg.js"),__vite__mapDeps([4,0,1])),"/auth":()=>d(()=>import("./page-authpage-BIx7dg_8.js"),__vite__mapDeps([9,0,1])),"/profile":()=>d(()=>import("./page-profilepage-BokF0LBc.js"),__vite__mapDeps([10,5,0,1]))};class M{constructor(e){this.root=e,this.init()}init(){window.addEventListener("popstate",()=>this.handleRoute()),document.body.addEventListener("click",e=>{const i=e.target.closest("a[data-link]");i&&(e.preventDefault(),this.navigate(i.getAttribute("href")))}),this.handleRoute()}navigate(e){window.history.pushState(null,null,e),this.handleRoute()}async handleRoute(){const e=new URL(window.location.href),i=e.pathname;let r="/",a={};const s={popular:"Animes Populares",movies:"Películas",latest:"Últimos Lanzamientos",dub:"Anime Latino",action:"Acción",comedy:"Comedia",romance:"Romance",supernatural:"Sobrenatural",adventure:"Aventura",drama:"Drama",fantasy:"Fantasía",music:"Musical","sci-fi":"Ciencia Ficción",seinen:"Seinen",shoujo:"Shoujo",shounen:"Shounen","slice-of-life":"Recuentos de la Vida",sports:"Deportes",thriller:"Thriller"};if(i.startsWith("/anime/"))r="/anime",a.id=i.split("/")[2],document.title="Cargando... — AniRD";else if(i.startsWith("/watch/")){r="/watch";const n=i.split("/");a.id=n[2],a.ep=n[3],a.lang=n[4]||"sub",document.title=`Ep. ${a.ep} — AniRD`}else i.startsWith("/category/")?(r="/category",a.name=i.split("/")[2],document.title=`${s[a.name]||"Explorar"} — AniRD`):i==="/search"?(r="/search",a.q=e.searchParams.get("q"),document.title=`Buscar "${a.q||""}" — AniRD`):i==="/profile"?(r="/profile",document.title="Mi Perfil — AniRD"):i==="/auth"?(r="/auth",document.title="Iniciar Sesión — AniRD"):i==="/calendar"?(r="/calendar",document.title="Calendario — AniRD"):i==="/history"||i==="/my-anird"?(r=p[i]?i:"/",document.title="Mi Historial — AniRD"):i==="/favorites"?(r="/favorites",document.title="Favoritos — AniRD"):(p[i]&&(r=i),document.title="AniRD — Tu plataforma de anime");S.getState().setCurrentRoute(i);const o=p[r]||p["/"];this.root.innerHTML='<div style="padding: 50px; text-align: center; color: white;">Cargando...</div>';try{const l=(await o()).default,h=new l(a);this.root.innerHTML="",this.root.appendChild(await h.render()),h.afterRender&&h.afterRender()}catch(n){console.error("Error loading route",n),this.root.innerHTML='<div style="padding: 50px; text-align: center; color: red;">Error al cargar la página</div>'}}}let m=null;const P=t=>(!m&&t&&(m=new M(t)),m);class N{constructor(e){this.router=e,this.timeout=null,this.render(),this.bindEvents()}render(){this.container=document.createElement("div"),this.container.className="search-overlay",this.container.id="searchOverlay",this.container.innerHTML=`
      <style>
        .search-overlay {
          position: fixed;
          inset: 0;
    ...
    `,document.body.appendChild(this.container),this.input=this.container.querySelector("#palette-input"),this.resultsContainer=this.container.querySelector("#palette-results")}bindEvents(){document.addEventListener("keydown",e=>{(e.metaKey||e.ctrlKey)&&e.key==="k"&&(e.preventDefault(),this.open()),e.key==="Escape"&&this.container.classList.contains("active")&&this.close()}),this.container.addEventListener("click",e=>{e.target===this.container&&this.close()}),this.input.addEventListener("input",e=>{const i=e.target.value.trim();if(clearTimeout(this.timeout),i.length<3){this.resultsContainer.innerHTML=`
      ...
      `,this.timeout=setTimeout(async()=>{try{const a=((await T.getAnimeSearch(i)).data||[]).slice(0,8);a.length>0?(this.resultsContainer.innerHTML=`
              <div class="result-group">
                <h4>Animes</h4>
...
`;document.body.insertBefore(I,b);const k=document.createElement("aside");k.className="desktop-sidebar";k.innerHTML=`
...
`;document.body.insertBefore(k,b);const _=()=>{const t=document.getElementById("profile-link"),e=document.getElementById("mobile-profile-link"),i=document.getElementById("sidebar-profile-link"),r=document.getElementById("profile-avatar-container"),a=document.getElementById("profile-username-text"),s=u.isLoggedIn(),o=u.getUser(),n=s?"/profile":"/auth";if(t&&(t.setAttribute("href",n),s?(r&&r.classList.add("active-border"),a&&(a.textContent=(o==null?void 0:o.username)||"Perfil")):(r&&r.classList.remove("active-border"),a&&(a.textContent="Entrar"))),e){e.setAttribute("href",n);const l=e.querySelector(".nav-label");l&&(l.textContent=s?"Perfil":"Entrar")}if(i){i.setAttribute("href",n);const l=i.querySelector("span");l&&(l.textContent=s?"Mi Perfil":"Entrar")}},B=t=>{const e=document.getElementById("bottomNav");if(!e)return;const i=e.querySelectorAll(".nav-item");i.forEach(a=>{a.classList.remove("active");const s=a.querySelector("svg");s&&s.setAttribute("stroke-width","1.8")});let r=-1;if(t==="/"||t.startsWith("/anime/")||t.startsWith("/category/")||t.startsWith("/watch/")||t==="/calendar"?r=0:t==="/favorites"?r=2:(t==="/profile"||t==="/auth")&&(r=3),r!==-1&&i[r]){i[r].classList.add("active");const a=i[r].querySelector("svg");a&&a.setAttribute("stroke-width","2.2")}},C=t=>{const e=document.querySelector(".desktop-sidebar");if(!e)return;e.querySelectorAll(".sidebar-link").forEach(s=>s.classList.remove("active"));let r="/";t==="/"||t.startsWith("/anime/")||t.startsWith("/watch/")||t.startsWith("/category/")||t==="/calendar"?r="/":t==="/favorites"?r="/favorites":t==="/history"||t==="/my-anird"?r="/history":(t==="/profile"||t==="/auth")&&(r="/profile");const a=e.querySelector(`.sidebar-link[data-route="${r}"]`);a&&a.classList.add("active")},R=async()=>{const t=document.getElementById("sidebar-following-list");if(t)try{const e=await y.getFollowing();if(e.length===0){t.innerHTML=`
      ...
      `}).join("")}catch(e){console.error("Error al renderizar siguiendo en la barra lateral:",e)}};S.subscribe(t=>{B(t.currentRoute),C(t.currentRoute),R()});window.updateNavbarAuth=_;_();B(window.location.pathname);C(window.location.pathname);R();const f=t=>{t&&t.preventDefault(),j.open()},w=document.getElementById("desktop-search-trigger");w&&w.addEventListener("click",f);const x=document.getElementById("open-search-btn");x&&x.addEventListener("click",f);const E=document.getElementById("mobile-search-btn");E&&E.addEventListener("click",f);const L=document.getElementById("sidebar-search-btn");L&&L.addEventListener("click",f);const g=document.getElementById("sidebar-categories-trigger"),A=document.getElementById("sidebar-categories-dropdown");g&&A&&g.addEventListener("click",t=>{t.preventDefault(),g.classList.toggle("expanded"),A.classList.toggle("expanded")});const q=async()=>{const t=document.getElementById("nav-notifications"),e=document.getElementById("notif-badge"),i=document.getElementById("notif-dropdown"),r=document.getElementById("notif-list"),a=document.getElementById("mark-read-btn");if(!t)return;const s=async()=>{await v.getUnreadCount()>0?(e.style.display="block",t.style.color="#ff0000"):(e.style.display="none",t.style.color="inherit")},o=async()=>{const n=await v.getNotifications();if(n.length===0){r.innerHTML='<div style="color:var(--text-muted); font-size:12px; text-align:center; padding: 20px 0;">No hay notificaciones nuevas</div>';return}r.innerHTML=n.map(l=>`
    ...
    `).join("")};t.addEventListener("click",async n=>{if(n.target===a)return;const l=i.style.display==="block";i.style.display=l?"none":"block",l||await o()}),a.addEventListener("click",async n=>{n.stopPropagation(),await v.markAllAsRead(),await s(),await o()}),document.addEventListener("click",n=>{t.contains(n.target)||(i.style.display="none")}),u.isLoggedIn()&&await v.checkNewEpisodes(),await s()},O=async()=>{if(await y.getSetting("theme","dark")==="light"&&document.body.classList.add("light-theme"),u.isLoggedIn())try{const e=await u.fetchFromServer();e&&await y.syncFromServer(e)}catch{console.error("Sync fail")}await q()};O();
