...
import{_ as c}from"./page-favoritespage-BsIX1kVp.js";import{c as q}from"./vendor-DIPEJTOH.js";import{a as F,b as d,d as A,c as y}from"./page-homepage-HfrhAw2J.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const _=q(i=>({theme:"dark",isDataSaver:!1,setTheme:e=>i({theme:e}),toggleDataSaver:()=>i(e=>({isDataSaver:!e.isDataSaver})),currentRoute:"/",setCurrentRoute:e=>i({currentRoute:e}),isSearchOpen:!1,setSearchOpen:e=>i({isSearchOpen:e})})),b={"/":()=>c(()=>import("./page-homepage-HfrhAw2J.js").then(i=>i.H),__vite__mapDeps([0,1])),"/anime":()=>c(()=>import("./page-animedetailpage-BoYs1ihs.js"),__vite__mapDeps([2,0,1])),"/watch":()=>c(()=>import("./page-watchpage-CgQp7min.js"),__vite__mapDeps([3,0,1])),"/history":()=>c(()=>import("./page-historypage-CqZNK3jg.js"),__vite__mapDeps([4,0,1])),"/favorites":()=>c(()=>import("./page-favoritespage-BsIX1kVp.js").then(i=>i.F),__vite__mapDeps([5,0,1])),"/search":()=>c(()=>import("./page-searchpage-bBXt4b5Y.js"),__vite__mapDeps([6,0,1])),"/category":()=>c(()=>import("./page-categorypage-BQusQMjN.js"),__vite__mapDeps([7,0,1])),"/calendar":()=>c(()=>import("./page-calendarpage-Dcd-pGqP.js"),__vite__mapDeps([8,0,1])),"/my-anird":()=>c(()=>import("./page-historypage-CqZNK3jg.js"),__vite__mapDeps([4,0,1])),"/auth":()=>c(()=>import("./page-authpage-BIx7dg_8.js"),__vite__mapDeps([9,0,1])),"/profile":()=>c(()=>import("./page-profilepage-BokF0LBc.js"),__vite__mapDeps([10,5,0,1]))};class j{constructor(e){this.root=e,this.init()}init(){window.addEventListener("popstate",()=>this.handleRoute()),document.body.addEventListener("click",e=>{const t=e.target.closest("a[data-link]");t&&(e.preventDefault(),this.navigate(t.getAttribute("href")))}),this.handleRoute()}navigate(e){window.history.pushState(null,null,e),this.handleRoute()}async handleRoute(){const e=new URL(window.location.href),t=e.pathname;let s="/",a={};const r={popular:"Animes Populares",movies:"Películas",latest:"Últimos Lanzamientos",dub:"Anime Latino",action:"Acción",comedy:"Comedia",romance:"Romance",supernatural:"Sobrenatural",adventure:"Aventura",drama:"Drama",fantasy:"Fantasía",music:"Musical","sci-fi":"Ciencia Ficción",seinen:"Seinen",shoujo:"Shoujo",shounen:"Shounen","slice-of-life":"Recuentos de la Vida",sports:"Deportes",thriller:"Thriller"};if(t.startsWith("/anime/"))s="/anime",a.id=t.split("/")[2],document.title="Cargando... — AniRD";else if(t.startsWith("/watch/")){s="/watch";const o=t.split("/");a.id=o[2],a.ep=o[3],a.lang=o[4]||"sub",document.title=`Ep. ${a.ep} — AniRD`}else t.startsWith("/category/")?(s="/category",a.name=t.split("/")[2],document.title=`${r[a.name]||"Explorar"} — AniRD`):t==="/search"?(s="/search",a.q=e.searchParams.get("q"),document.title=`Buscar "${a.q||""}" — AniRD`):t==="/profile"?(s="/profile",document.title="Mi Perfil — AniRD"):t==="/auth"?(s="/auth",document.title="Iniciar Sesión — AniRD"):t==="/calendar"?(s="/calendar",document.title="Calendario — AniRD"):t==="/history"||t==="/my-anird"?(s=b[t]?t:"/",document.title="Mi Historial — AniRD"):t==="/favorites"?(s="/favorites",document.title="Favoritos — AniRD"):(b[t]&&(s=t),document.title="AniRD — Tu plataforma de anime");_.getState().setCurrentRoute(t);const n=b[s]||b["/"];this.root.innerHTML='<div style="padding: 50px; text-align: center; color: white;">Cargando...</div>';try{const l=(await n()).default,v=new l(a);this.root.innerHTML="",this.root.appendChild(await v.render()),v.afterRender&&v.afterRender()}catch(o){console.error("Error loading route",o),this.root.innerHTML='<div style="padding: 50px; text-align: center; color: red;">Error al cargar la página</div>'}}}let x=null;const H=i=>(!x&&i&&(x=new j(i)),x);class ${constructor(e){this.router=e,this.timeout=null,this.render(),this.bindEvents()}render(){this.container=document.createElement("div"),this.container.className="search-overlay",this.container.id="searchOverlay",this.container.innerHTML=`
      <style>
        .search-overlay {
          position: fixed;
          inset: 0;
    ...
    `,document.body.appendChild(this.container),this.input=this.container.querySelector("#palette-input"),this.resultsContainer=this.container.querySelector("#palette-results")}bindEvents(){document.addEventListener("keydown",e=>{(e.metaKey||e.ctrlKey)&&e.key==="k"&&(e.preventDefault(),this.open()),e.key==="Escape"&&this.container.classList.contains("active")&&this.close()}),this.container.addEventListener("click",e=>{e.target===this.container&&this.close()}),this.input.addEventListener("input",e=>{const t=e.target.value.trim();if(clearTimeout(this.timeout),t.length<3){this.resultsContainer.innerHTML=`
      ...
      `,this.timeout=setTimeout(async()=>{try{const a=((await F.getAnimeSearch(t)).data||[]).slice(0,8);a.length>0?(this.resultsContainer.innerHTML=`
              <div class="result-group">
                <h4>Animes</h4>
          ...
          `}},400)}),this.input.addEventListener("keydown",e=>{if(e.key==="Enter"){const t=this.input.value.trim();t&&(this.close(),this.router.navigate(`/search?q=${encodeURIComponent(t)}`))}})}open(){this.container.classList.add("active"),this.input.focus()}close(){this.container.classList.remove("active"),this.input.value=""}}class U{constructor(){this.isActive=!1,this.focusedElement=null,this.focusableElements=[],this.handleKeyDownBound=this.handleKeyDown.bind(this),this.mutationObserver=null}init(){this.isActive||(this.isActive=!0,document.body.classList.add("tv-mode"),localStorage.setItem("tvMode","true"),window.addEventListener("keydown",this.handleKeyDownBound,{capture:!0}),this.setupMutationObserver(),setTimeout(()=>{this.updateFocusables(),this.focusFirstAvailable()},300),console.log("📺 AniRD Spatial Navigation (Smart TV Mode) initialized."))}destroy(){if(!this.isActive)return;this.isActive=!1,document.body.classList.remove("tv-mode"),localStorage.setItem("tvMode","false"),window.removeEventListener("keydown",this.handleKeyDownBound,{capture:!0}),this.mutationObserver&&(this.mutationObserver.disconnect(),this.mutationObserver=null),this.focusedElement&&(this.focusedElement.classList.remove("focused"),this.focusedElement=null),document.querySelectorAll(".focused").forEach(t=>t.classList.remove("focused")),console.log("📺 AniRD Spatial Navigation (Smart TV Mode) destroyed.")}setupMutationObserver(){this.mutationObserver&&this.mutationObserver.disconnect(),this.mutationObserver=new MutationObserver(()=>{this.updateTimeout&&clearTimeout(this.updateTimeout),this.updateTimeout=setTimeout(()=>{this.isActive&&this.updateFocusables()},200)}),this.mutationObserver.observe(document.body,{childList:!0,subtree:!0})}updateFocusables(){if(!this.isActive)return;const e=["a[href]","button",'input:not([type="hidden"])',"select","textarea",'[tabindex]:not([tabindex="-1"])',"anime-card",".anime-card",".episode-btn",".sidebar-link",".search-bar-desktop",".header-profile-btn",".server-btn",".player-control-btn",".category-item",".sidebar-categories-trigger",".control-btn-v5",".server-pill-v5",".lang-pill-v5",".btn-more-v5",".ep-search-input-v5",".sidebar-icon-btn",".ep-item-horizontal-v5",".related-card-v5",'[role="button"]'].join(", "),t=Array.from(document.querySelectorAll(e));this.focusableElements=t.filter(s=>{if(s.disabled||s.getAttribute("aria-disabled")==="true")return!1;if(s.id==="tv-mode-toggle")return!0;const a=s.getBoundingClientRect();if(a.width===0||a.height===0)return!1;const r=window.getComputedStyle(s);if(r.display==="none"||r.visibility==="hidden"||r.opacity==="0")return!1;let n=s.parentElement;for(;n;){if(window.getComputedStyle(n).display==="none")return!1;n=n.parentElement}return!0}),this.focusedElement&&!this.focusableElements.includes(this.focusedElement)&&(this.focusedElement.classList.remove("focused"),this.focusedElement=null,this.focusFirstAvailable())}focusFirstAvailable(){if(this.focusableElements.length>0){let e=this.focusableElements.find(t=>t.classList.contains("sidebar-link")||t.tagName==="ANIME-CARD"||t.classList.contains("ep-item-horizontal-v5"));e||(e=this.focusableElements[0]),this.focusElement(e)}}focusElement(e){e&&(this.focusedElement&&(this.focusedElement.classList.remove("focused"),typeof this.focusedElement.blur=="function"&&this.focusedElement.blur()),this.focusedElement=e,this.focusedElement.classList.add("focused"),typeof this.focusedElement.focus=="function"&&this.focusedElement.focus(),this.focusedElement.scrollIntoView({behavior:"smooth",block:"nearest",inline:"nearest"}))}handleKeyDown(e){var a;if(!this.isActive)return;const t=document.activeElement?document.activeElement.tagName:"",s=t==="INPUT"||t==="TEXTAREA";if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"].includes(e.key)){if(s&&["ArrowLeft","ArrowRight"].includes(e.key))return;e.preventDefault(),e.stopPropagation();const r=e.key.replace("Arrow","").toLowerCase();this.moveFocus(r);return}if(e.key==="Enter"){if(s)return;if(this.focusedElement)if(e.preventDefault(),e.stopPropagation(),console.log("📺 TV D-pad Select: Enter key triggered on element:",this.focusedElement),this.focusedElement.tagName==="ANIME-CARD"){const r=(a=this.focusedElement.shadowRoot)==null?void 0:a.querySelector("a");r?r.click():this.focusedElement.click()}else this.focusedElement.click();return}if(e.key==="Backspace"||e.key==="Escape"){if(s&&e.key==="Backspace")return;const r=document.getElementById("searchOverlay");if(r&&r.classList.contains("active"))return;e.preventDefault(),e.stopPropagation(),console.log("📺 TV D-pad Back: navigating history back"),window.history.back()}}moveFocus(e){if(this.updateFocusables(),this.focusableElements.length===0)return;if(!this.focusedElement||!this.focusableElements.includes(this.focusedElement)){this.focusFirstAvailable();return}const t=this.focusedElement.getBoundingClientRect(),s=t.left+t.width/2,a=t.top+t.height/2;let r=null,n=1/0;for(const o of this.focusableElements){if(o===this.focusedElement)continue;const l=o.getBoundingClientRect(),v=l.left+l.width/2,z=l.top+l.height/2,p=v-s,f=z-a;let h=0,m=0,g=!1;switch(e){case"right":p>5&&(h=p,m=Math.abs(f),g=!0);break;case"left":p<-5&&(h=-p,m=Math.abs(f),g=!0);break;case"down":f>5&&(h=f,m=Math.abs(p),g=!0);break;case"up":f<-5&&(h=-f,m=Math.abs(p),g=!0);break}if(g){const T=h+m*3;T<n&&(n=T,r=o)}}r?this.focusElement(r):console.log(`📺 No focusable candidate found in direction: ${e}`)}}const u=new U,k={async checkNewEpisodes(){const i=await d.following.toArray();let e=!1;for(const t of i)if(t.status==="Currently Airing"&&t.broadcast&&t.broadcast.day&&t.broadcast.day!=="Unknown"){const s=this.getLastBroadcast(t.broadcast);s&&(!t.lastNotified||s>t.lastNotified)&&(await d.notifications.where("animeId").equals(t.animeId).and(r=>r.timestamp===s).first()||(await d.notifications.add({animeId:t.animeId,isRead:0,timestamp:s}),e=!0),await d.following.update(t.animeId,{lastNotified:s}))}return e},getLastBroadcast(i){const e={Sundays:0,Mondays:1,Tuesdays:2,Wednesdays:3,Thursdays:4,Fridays:5,Saturdays:6};if(e[i.day]===void 0)return null;const[t,s]=i.time.split(":").map(Number),a=new Date(new Date().toLocaleString("en-US",{timeZone:i.timezone||"Asia/Tokyo"}));let r=new Date(a);r.setHours(t,s,0,0);let n=e[i.day]-a.getDay();(n<0||n===0&&r<=a)&&(n+=7),r.setDate(r.getDate()+n);const o=new Date(r);if(o.setDate(o.getDate()-7),o>a)return null;const l=o.getTime()-a.getTime();return Date.now()+l},async getUnreadCount(){return await d.notifications.where("isRead").equals(0).count()},async getNotifications(){const i=await d.notifications.orderBy("timestamp").reverse().toArray(),e=[];for(const t of i){const s=await d.following.get(t.animeId);s&&e.push({...t,title:s.title,cover:s.cover})}return e},async markAllAsRead(){await d.notifications.where("isRead").equals(0).modify({isRead:1})}},L=document.getElementById("app"),W=H(L),K=new $(W),M=document.createElement("header");M.innerHTML=`
...
`;document.body.insertBefore(S,L);const N=()=>{const i=document.getElementById("profile-link"),e=document.getElementById("mobile-profile-link"),t=document.getElementById("sidebar-profile-link"),s=document.getElementById("profile-avatar-container"),a=document.getElementById("profile-username-text"),r=y.isLoggedIn(),n=y.getUser(),o=r?"/profile":"/auth";if(i&&(i.setAttribute("href",o),r?(s&&s.classList.add("active-border"),a&&(a.textContent=(n==null?void 0:n.username)||"Perfil")):(s&&s.classList.remove("active-border"),a&&(a.textContent="Entrar"))),e){e.setAttribute("href",o);const l=e.querySelector(".nav-label");l&&(l.textContent=r?"Perfil":"Entrar")}if(t){t.setAttribute("href",o);const l=t.querySelector("span");l&&(l.textContent=r?"Mi Perfil":"Entrar")}},O=i=>{const e=document.getElementById("bottomNav");if(!e)return;const t=e.querySelectorAll(".nav-item");t.forEach(a=>{a.classList.remove("active");const r=a.querySelector("svg");r&&r.setAttribute("stroke-width","1.8")});let s=-1;if(i==="/"||i.startsWith("/anime/")||i.startsWith("/category/")||i.startsWith("/watch/")||i==="/calendar"?s=0:i==="/favorites"?s=2:(i==="/profile"||i==="/auth")&&(s=3),s!==-1&&t[s]){t[s].classList.add("active");const a=t[s].querySelector("svg");a&&a.setAttribute("stroke-width","2.2")}},P=i=>{const e=document.querySelector(".desktop-sidebar");if(!e)return;e.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active"));let s="/";i==="/"||i.startsWith("/anime/")||i.startsWith("/watch/")||i.startsWith("/category/")||i==="/calendar"?s="/":i==="/favorites"?s="/favorites":i==="/history"||i==="/my-anird"?s="/history":(i==="/profile"||i==="/auth")&&(s="/profile");const a=e.querySelector(`.sidebar-link[data-route="${s}"]`);a&&a.classList.add("active")},V=async()=>{const i=document.getElementById("sidebar-following-list");if(i)try{const e=await A.getFollowing();if(e.length===0){i.innerHTML=`
        <div class="sidebar-following-empty">
          Aún no sigues ningún anime. Haz clic en "Seguir" en la ficha del anime para agregarlo aquí.
        </div>
      `;return}const t=await d.history.orderBy("updatedAt").reverse().toArray(),s=new Map;t.forEach(a=>{s.has(a.animeId)||s.set(a.animeId,a.episodeId)}),i.innerHTML=e.slice(0,5).map(a=>{const r=Number(a.animeId),n=s.get(r),o=n?`Ep. ${n}`:"Ver ahora";return`
      ...
      `}).join("")}catch(e){console.error("Error al renderizar siguiendo en la barra lateral:",e)}};_.subscribe(i=>{O(i.currentRoute),P(i.currentRoute),V(),u.isActive&&setTimeout(()=>{u.updateFocusables(),u.focusFirstAvailable()},400)});window.updateNavbarAuth=N;N();O(window.location.pathname);P(window.location.pathname);V();const w=i=>{i&&i.preventDefault(),K.open()},D=document.getElementById("desktop-search-trigger");D&&D.addEventListener("click",w);const I=document.getElementById("open-search-btn");I&&I.addEventListener("click",w);const B=document.getElementById("mobile-search-btn");B&&B.addEventListener("click",w);const R=document.getElementById("sidebar-search-btn");R&&R.addEventListener("click",w);const E=document.getElementById("sidebar-categories-trigger"),C=document.getElementById("sidebar-categories-dropdown");E&&C&&E.addEventListener("click",i=>{i.preventDefault(),E.classList.toggle("expanded"),C.classList.toggle("expanded")});const G=async()=>{const i=document.getElementById("nav-notifications"),e=document.getElementById("notif-badge"),t=document.getElementById("notif-dropdown"),s=document.getElementById("notif-list"),a=document.getElementById("mark-read-btn");if(!i)return;const r=async()=>{await k.getUnreadCount()>0?(e.style.display="block",i.style.color="#ff0000"):(e.style.display="none",i.style.color="inherit")},n=async()=>{const o=await k.getNotifications();if(o.length===0){s.innerHTML='<div style="color:var(--text-muted); font-size:12px; text-align:center; padding: 20px 0;">No hay notificaciones nuevas</div>';return}s.innerHTML=o.map(l=>`
    ...
    `).join("")};i.addEventListener("click",async o=>{if(o.target===a)return;const l=t.style.display==="block";t.style.display=l?"none":"block",l||await n()}),a.addEventListener("click",async o=>{o.stopPropagation(),await k.markAllAsRead(),await r(),await n()}),document.addEventListener("click",o=>{i.contains(o.target)||(t.style.display="none")}),y.isLoggedIn()&&await k.checkNewEpisodes(),await r()},X=()=>{const i=document.getElementById("tv-mode-toggle"),e=document.getElementById("tv-mode-text"),t=n=>{e&&(e.textContent=n?"📺 Modo TV: ON":"📺 Modo TV: OFF"),i&&(n?i.classList.add("active"):i.classList.remove("active"))},s=()=>{u.isActive?(u.destroy(),t(!1)):(u.init(),t(!0))};i&&i.addEventListener("click",n=>{n.preventDefault(),s()});const a=localStorage.getItem("tvMode")==="true",r=/SmartTV|GoogleTV|AppleTV|HbbTV|LG NetCast|Opera TV|Tizen|Web0S|Nexus Player|AndroidTV|Roku/i.test(navigator.userAgent);a||localStorage.getItem("tvMode")===null&&r?(u.init(),t(!0)):t(!1)},Z=async()=>{if(await A.getSetting("theme","dark")==="light"&&document.body.classList.add("light-theme"),y.isLoggedIn())try{const e=await y.fetchFromServer();e&&await A.syncFromServer(e)}catch{console.error("Sync fail")}await G(),setTimeout(X,200)};Z();
