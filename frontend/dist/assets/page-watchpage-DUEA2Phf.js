const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-homepage-hw3Gvt4E.js","assets/vendor-DIPEJTOH.js","assets/page-animedetailpage-JWj__RTx.js","assets/page-historypage-BGTpDy_z.js","assets/page-favoritespage-BCRZPGIo.js","assets/page-searchpage-D4zlvFjL.js","assets/page-categorypage-BWtARgh9.js","assets/page-calendarpage-Dg2OcR1B.js","assets/page-authpage-Co6mBlNv.js","assets/page-profilepage-DaMbmdFr.js","assets/page-mylistspage-DQTYSp94.js"])))=>i.map(i=>d[i]);
import{a as C,d as S,b as I}from"./page-homepage-hw3Gvt4E.js";import{c as k}from"./vendor-DIPEJTOH.js";import{T as D}from"./page-animedetailpage-JWj__RTx.js";const P="modulepreload",M=function(g){return"/"+g},$={},E=function(e,t,s){let a=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));a=Promise.allSettled(t.map(o=>{if(o=M(o),o in $)return;$[o]=!0;const p=o.endsWith(".css"),d=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${d}`))return;const r=document.createElement("link");if(r.rel=p?"stylesheet":P,p||(r.as="script"),r.crossOrigin="",r.href=o,i&&r.setAttribute("nonce",i),document.head.appendChild(r),p)return new Promise((x,b)=>{r.addEventListener("load",x),r.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function l(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return a.then(n=>{for(const i of n||[])i.status==="rejected"&&l(i.reason);return e().catch(l)})},B=k(g=>({theme:"dark",isDataSaver:!1,setTheme:e=>g({theme:e}),toggleDataSaver:()=>g(e=>({isDataSaver:!e.isDataSaver})),currentRoute:"/",setCurrentRoute:e=>g({currentRoute:e}),isSearchOpen:!1,setSearchOpen:e=>g({isSearchOpen:e})})),_={"/":()=>E(()=>import("./page-homepage-hw3Gvt4E.js").then(g=>g.H),__vite__mapDeps([0,1])),"/anime":()=>E(()=>import("./page-animedetailpage-JWj__RTx.js").then(g=>g.A),__vite__mapDeps([2,0,1])),"/watch":()=>E(()=>Promise.resolve().then(()=>F),void 0),"/history":()=>E(()=>import("./page-historypage-BGTpDy_z.js"),__vite__mapDeps([3,0,1])),"/favorites":()=>E(()=>import("./page-favoritespage-BCRZPGIo.js"),__vite__mapDeps([4,0,1,2])),"/search":()=>E(()=>import("./page-searchpage-D4zlvFjL.js"),__vite__mapDeps([5,0,1])),"/category":()=>E(()=>import("./page-categorypage-BWtARgh9.js"),__vite__mapDeps([6,0,1])),"/calendar":()=>E(()=>import("./page-calendarpage-Dg2OcR1B.js"),__vite__mapDeps([7,0,1])),"/my-anird":()=>E(()=>import("./page-historypage-BGTpDy_z.js"),__vite__mapDeps([3,0,1])),"/auth":()=>E(()=>import("./page-authpage-Co6mBlNv.js"),__vite__mapDeps([8,0,1])),"/profile":()=>E(()=>import("./page-profilepage-DaMbmdFr.js").then(g=>g.P),__vite__mapDeps([9,0,1])),"/lists":()=>E(()=>import("./page-mylistspage-DQTYSp94.js"),__vite__mapDeps([10,0,1,2]))};class O{constructor(e){this.root=e,this.init()}init(){window.addEventListener("popstate",()=>this.handleRoute()),document.body.addEventListener("click",e=>{const s=e.composedPath().find(a=>a.tagName==="A"&&a.hasAttribute("data-link"));s&&(e.preventDefault(),this.navigate(s.getAttribute("href")))}),this.handleRoute()}navigate(e){window.history.pushState(null,null,e),this.handleRoute()}async handleRoute(){const e=new URL(window.location.href),t=e.pathname;let s="/",a={};const l={popular:"Animes Populares",movies:"Películas",latest:"Últimos Lanzamientos",dub:"Anime Latino",action:"Acción",comedy:"Comedia",romance:"Romance",supernatural:"Sobrenatural",adventure:"Aventura",drama:"Drama",fantasy:"Fantasía",music:"Musical","sci-fi":"Ciencia Ficción",seinen:"Seinen",shoujo:"Shoujo",shounen:"Shounen","slice-of-life":"Recuentos de la Vida",sports:"Deportes",thriller:"Thriller"};if(t.startsWith("/anime/"))s="/anime",a.id=t.substring(7),document.title="Cargando... — AniRD";else if(t.startsWith("/watch/")){s="/watch";const r=t.substring(7).split("/");r.length>=3?(a.lang=r[r.length-1],a.ep=r[r.length-2],a.id=r.slice(0,r.length-2).join("/")):(a.id=r[0],a.ep=r[1]||"1",a.lang=r[2]||"sub"),document.title=`Ep. ${a.ep} — AniRD`}else t.startsWith("/category/")?(s="/category",a.name=t.split("/")[2],document.title=`${l[a.name]||"Explorar"} — AniRD`):t==="/search"?(s="/search",a.q=e.searchParams.get("q"),document.title=`Buscar "${a.q||""}" — AniRD`):t==="/profile"?(s="/profile",document.title="Mi Perfil — AniRD"):t==="/auth"?(s="/auth",document.title="Iniciar Sesión — AniRD"):t==="/calendar"?(s="/calendar",document.title="Calendario — AniRD"):t==="/history"||t==="/my-anird"?(s=_[t]?t:"/",document.title="Mi Historial — AniRD"):t==="/favorites"?(s="/favorites",document.title="Favoritos — AniRD"):t==="/lists"?(s="/lists",document.title="Mis Listas — AniRD"):(_[t]&&(s=t),document.title="AniRD — Tu plataforma de anime");const n=[];for(let d=0;d<document.body.classList.length;d++){const r=document.body.classList[d];r&&r.startsWith("route-")&&n.push(r)}n.forEach(d=>document.body.classList.remove(d));const i=`route-${s.replace("/","")||"home"}`;document.body.classList.add(i),B.getState().setCurrentRoute(t);const o=_[s]||_["/"];this.root.innerHTML=`
    ...
    `;let p;try{p=await o()}catch(d){console.warn("⚠️ Error al cargar componente de ruta, reintentando en 500ms...",d),await new Promise(r=>setTimeout(r,500));try{p=await o()}catch(r){console.error("❌ Fallo crítico al cargar ruta después de reintentar:",r),this.root.innerHTML=`
        ...
        `;return}}try{const d=p.default,r=new d(a);this.root.innerHTML="",this.root.appendChild(await r.render()),r.afterRender&&r.afterRender(),s==="/"&&(typeof window.requestIdleCallback=="function"?window.requestIdleCallback(()=>{_["/anime"]().catch(()=>{}),_["/watch"]().catch(()=>{})}):setTimeout(()=>{_["/anime"]().catch(()=>{}),_["/watch"]().catch(()=>{})},1500)),window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0}catch(d){console.error("Error al inicializar o renderizar la página:",d),this.root.innerHTML=`<div style="padding: 100px; text-align: center; color: red; font-family:'Outfit';"><h3>Error al renderizar el contenido</h3></div>`}}}let R=null;const N=g=>(!R&&g&&(R=new O(g)),R);class W{constructor(e){this.params=e,this.animeId=isNaN(Number(e.id))?e.id:parseInt(e.id),this.episodeNum=parseInt(e.ep)||1,this.lang=e.lang||"sub",this.anime=null,this.localInfo=null,this.episodeData=null,this.relatedAnimes=[],this.anilistEpisodes=[],this.isFav=!1,this.watchedEpisodes=new Set,this.isTheater=localStorage.getItem("watch-theater-mode")==="true",this.sortDesc=!1,this.searchQuery=""}async render(){var o,p,d,r,x,b;try{console.log("Iniciando carga de WatchPage Premium para ID:",this.animeId,"Episodio:",this.episodeNum);const u=await C.getAnimeInfo(this.animeId);u&&u.data&&(this.anime=u.data);const h=new URLSearchParams(window.location.search).get("title"),v=[];if(this.anime&&(v.push(this.anime.title),this.anime.title_english&&v.push(this.anime.title_english),this.anime.title_japanese&&v.push(this.anime.title_japanese),this.anime.title_synonyms&&v.push(...this.anime.title_synonyms)),h&&!v.includes(h)&&v.push(h),v.length>0){let f=null;for(const c of v){const y=await C.searchLocal(c);if(y&&y.success&&y.data&&y.data.results&&y.data.results.length>0){f=y;break}}if(f){const c=f.data.results.find(A=>v.some(L=>A.title.toLowerCase().includes(L.toLowerCase())))||f.data.results[0];this.anime||(this.anime={title:c.title,images:{jpg:{large_image_url:c.thumbnail}},genres:[],synopsis:"Cargado desde el servidor local de AniRD."});const y=await C.getAnimeInfo(c.url);if(y.success){this.localInfo=y.data;const A=this.localInfo.episodes.find(L=>L.number===this.episodeNum);if(A&&A.url){const L=await C.getEpisode(A.url);if(L.success&&L.data){this.episodeData=L.data;const T=this.episodeData.servers[this.lang]||this.episodeData.servers.sub||[];this.episodeData.activeServers=T}}}}}this.isFav=await S.isFavorite(this.animeId);const w=await I.history.where({animeId:String(this.animeId)}).toArray();this.watchedEpisodes=new Set(w.map(f=>Number(f.episodeId)))}catch(u){console.error("Error crítico al renderizar WatchPage Premium:",u)}const e=document.createElement("div");if(e.className="page-enter",!this.anime)return e.innerHTML=`
      ...
      `,e;document.title=`${this.anime.title} — Episodio ${this.episodeNum} (${this.lang.toUpperCase()}) — AniRD`;const t=this.watchedEpisodes.has(this.episodeNum),s=`https://anilist.co/search/anime?search=${encodeURIComponent(this.anime.title)}`,a=`https://myanimelist.net/anime/${this.anime.mal_id||""}`,l=((p=(o=this.anime.images)==null?void 0:o.jpg)==null?void 0:p.large_image_url)||"",n=((r=(d=this.anime.images)==null?void 0:d.jpg)==null?void 0:r.large_image_url)||l;let i="";if(this.anime.status==="Currently Airing"&&this.anime.broadcast&&this.anime.broadcast.time){const u=this.anime.broadcast,m={Sundays:0,Mondays:1,Tuesdays:2,Wednesdays:3,Thursdays:4,Fridays:5,Saturdays:6};if(m[u.day]!==void 0){const[h,v]=u.time.split(":").map(Number),w=new Date(new Date().toLocaleString("en-US",{timeZone:u.timezone||"Asia/Tokyo"}));let f=new Date(w);f.setHours(h,v,0,0);let c=m[u.day]-w.getDay();(c<0||c===0&&f<w)&&(c+=7),f.setDate(f.getDate()+c),f-w>0&&(i=`
          ...
          <div class="selection-container-v5">
            <div class="server-selection-v5">
              ...
              <div class="server-pills-v5" id="server-pills">
                ${this.episodeData&&this.episodeData.activeServers&&this.episodeData.activeServers.length>0?this.episodeData.activeServers.map((u,m)=>`
                      <button class="server-pill-v5 ${m===0?"active":""}" data-url="${u.url}">
                        🚀 ${u.server}
                      </button>
          ...
          <div class="anime-details-card-v5">
            ...
            <div class="details-info-v5">
              ...
              <div class="details-grid-fields-v5">
                <div class="field-item-v5"><strong>Estudio:</strong> ${((x=this.anime.studios)==null?void 0:x.map(u=>u.name).join(", "))||"Desconocido"}</div>
        ...
        `}).join("")}else e.innerHTML='<p style="color:var(--text-muted); font-size:12px; font-weight:600;">No hay recomendaciones similares disponibles.</p>';if(this.localInfo&&this.localInfo.episodes){const i=this.localInfo.episodes,o=((n=(l=this.anime.images)==null?void 0:l.jpg)==null?void 0:n.large_image_url)||"",p=this.anime.title,d=()=>{let b=[...i];if(this.sortDesc&&b.reverse(),this.searchQuery.trim()!==""&&(b=b.filter(m=>String(m.number).includes(this.searchQuery)||m.title&&m.title.toLowerCase().includes(this.searchQuery.toLowerCase()))),b.length===0){t.innerHTML='<p style="color:var(--text-muted); text-align:center; padding:20px; font-size:11px;">No se encontraron episodios.</p>';return}t.innerHTML=b.map(m=>{let h=`Episodio ${m.number}`,v=o;const w=a[m.number-1];if(w&&(w.title&&(h=w.title.replace(/^Episode \d+\s*-?\s*/i,"")),w.thumbnail&&(v=w.thumbnail)),m.number===this.episodeNum){const T=document.getElementById("active-episode-title");T&&(T.textContent=`${this.anime.title} — ${h}`)}const f=m.number===this.episodeNum,c=this.watchedEpisodes.has(m.number),y=`/watch/${this.animeId}/${m.number}/${this.lang}?title=${encodeURIComponent(p)}`,A=c?'<div class="ep-watched-badge-v5">✓ Visto</div>':"",L=c?'<div class="ep-progress-bar-v5"><div class="ep-progress-fill-v5"></div></div>':"";return`
            <a href="${y}" data-link class="ep-item-horizontal-v5 ${f?"active":""} ${c?"watched":""}">
              ...
              <div class="ep-info-v5">
                <span class="ep-number-v5">Episodio ${m.number}</span>
                <span class="ep-title-v5">${h}</span>
              </div>
            </a>
          `}).join("");const u=document.getElementById("btn-watched-all");if(u&&this.localInfo&&this.localInfo.episodes){const h=this.localInfo.episodes.map(v=>v.number).every(v=>this.watchedEpisodes.has(v));u.classList.toggle("active",h),u.title=h?"Desmarcar toda la temporada":"Marcar toda la temporada como vista"}};this.renderEpisodes=d,d();const r=document.getElementById("ep-search-input");r&&r.addEventListener("input",b=>{this.searchQuery=b.target.value,d()});const x=document.getElementById("btn-sort-ep");x&&x.addEventListener("click",()=>{this.sortDesc=!this.sortDesc,x.classList.toggle("active",this.sortDesc),d()})}else t&&(t.innerHTML=`
