const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-homepage-CMAm-BoN.js","assets/vendor-DIPEJTOH.js","assets/page-animedetailpage-D5KPHKxt.js","assets/page-historypage-XqPv3F09.js","assets/page-favoritespage-B8mGRuS8.js","assets/page-searchpage-CNO8RP7x.js","assets/page-categorypage-Cy4yzcLk.js","assets/page-calendarpage-DOgkCfyE.js","assets/page-authpage-C-mLlBBw.js","assets/page-profilepage-CCJXv_cR.js","assets/page-mylistspage-Bms0Oazl.js"])))=>i.map(i=>d[i]);
import{a as C,d as _,b as S}from"./page-homepage-CMAm-BoN.js";import{c as P}from"./vendor-DIPEJTOH.js";import{T}from"./page-animedetailpage-D5KPHKxt.js";const M="modulepreload",B=function(f){return"/"+f},$={},I=function(e,t,s){let a=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),i=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));a=Promise.allSettled(t.map(o=>{if(o=B(o),o in $)return;$[o]=!0;const c=o.endsWith(".css"),r=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${r}`))return;const d=document.createElement("link");if(d.rel=c?"stylesheet":M,c||(d.as="script"),d.crossOrigin="",d.href=o,i&&d.setAttribute("nonce",i),document.head.appendChild(d),c)return new Promise((L,E)=>{d.addEventListener("load",L),d.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${o}`)))})}))}function n(l){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=l,window.dispatchEvent(i),!i.defaultPrevented)throw l}return a.then(l=>{for(const i of l||[])i.status==="rejected"&&n(i.reason);return e().catch(n)})},O=P(f=>({theme:"dark",isDataSaver:!1,setTheme:e=>f({theme:e}),toggleDataSaver:()=>f(e=>({isDataSaver:!e.isDataSaver})),currentRoute:"/",setCurrentRoute:e=>f({currentRoute:e}),isSearchOpen:!1,setSearchOpen:e=>f({isSearchOpen:e})})),D={"/":()=>I(()=>import("./page-homepage-CMAm-BoN.js").then(f=>f.H),__vite__mapDeps([0,1])),"/anime":()=>I(()=>import("./page-animedetailpage-D5KPHKxt.js").then(f=>f.A),__vite__mapDeps([2,0,1])),"/watch":()=>I(()=>Promise.resolve().then(()=>V),void 0),"/history":()=>I(()=>import("./page-historypage-XqPv3F09.js"),__vite__mapDeps([3,0,1])),"/favorites":()=>I(()=>import("./page-favoritespage-B8mGRuS8.js"),__vite__mapDeps([4,0,1,2])),"/search":()=>I(()=>import("./page-searchpage-CNO8RP7x.js"),__vite__mapDeps([5,0,1])),"/category":()=>I(()=>import("./page-categorypage-Cy4yzcLk.js"),__vite__mapDeps([6,0,1])),"/calendar":()=>I(()=>import("./page-calendarpage-DOgkCfyE.js"),__vite__mapDeps([7,0,1])),"/my-anird":()=>I(()=>import("./page-historypage-XqPv3F09.js"),__vite__mapDeps([3,0,1])),"/auth":()=>I(()=>import("./page-authpage-C-mLlBBw.js"),__vite__mapDeps([8,0,1])),"/profile":()=>I(()=>import("./page-profilepage-CCJXv_cR.js").then(f=>f.P),__vite__mapDeps([9,0,1])),"/lists":()=>I(()=>import("./page-mylistspage-Bms0Oazl.js"),__vite__mapDeps([10,0,1,2]))};class N{constructor(e){this.root=e,this.init()}init(){window.addEventListener("popstate",()=>this.handleRoute()),document.body.addEventListener("click",e=>{const t=e.target.closest("a[data-link]");t&&(e.preventDefault(),this.navigate(t.getAttribute("href")))}),this.handleRoute()}navigate(e){window.history.pushState(null,null,e),this.handleRoute()}async handleRoute(){const e=new URL(window.location.href),t=e.pathname;let s="/",a={};const n={popular:"Animes Populares",movies:"Películas",latest:"Últimos Lanzamientos",dub:"Anime Latino",action:"Acción",comedy:"Comedia",romance:"Romance",supernatural:"Sobrenatural",adventure:"Aventura",drama:"Drama",fantasy:"Fantasía",music:"Musical","sci-fi":"Ciencia Ficción",seinen:"Seinen",shoujo:"Shoujo",shounen:"Shounen","slice-of-life":"Recuentos de la Vida",sports:"Deportes",thriller:"Thriller"};if(t.startsWith("/anime/"))s="/anime",a.id=t.split("/")[2],document.title="Cargando... — AniRD";else if(t.startsWith("/watch/")){s="/watch";const r=t.split("/");a.id=r[2],a.ep=r[3],a.lang=r[4]||"sub",document.title=`Ep. ${a.ep} — AniRD`}else t.startsWith("/category/")?(s="/category",a.name=t.split("/")[2],document.title=`${n[a.name]||"Explorar"} — AniRD`):t==="/search"?(s="/search",a.q=e.searchParams.get("q"),document.title=`Buscar "${a.q||""}" — AniRD`):t==="/profile"?(s="/profile",document.title="Mi Perfil — AniRD"):t==="/auth"?(s="/auth",document.title="Iniciar Sesión — AniRD"):t==="/calendar"?(s="/calendar",document.title="Calendario — AniRD"):t==="/history"||t==="/my-anird"?(s=D[t]?t:"/",document.title="Mi Historial — AniRD"):t==="/favorites"?(s="/favorites",document.title="Favoritos — AniRD"):t==="/lists"?(s="/lists",document.title="Mis Listas — AniRD"):(D[t]&&(s=t),document.title="AniRD — Tu plataforma de anime");const l=[];for(let r=0;r<document.body.classList.length;r++){const d=document.body.classList[r];d&&d.startsWith("route-")&&l.push(d)}l.forEach(r=>document.body.classList.remove(r));const i=`route-${s.replace("/","")||"home"}`;document.body.classList.add(i),O.getState().setCurrentRoute(t);const o=D[s]||D["/"];this.root.innerHTML=`
    ...
    `;let c;try{c=await o()}catch(r){console.warn("⚠️ Error al cargar componente de ruta, reintentando en 500ms...",r),await new Promise(d=>setTimeout(d,500));try{c=await o()}catch(d){console.error("❌ Fallo crítico al cargar ruta después de reintentar:",d),this.root.innerHTML=`
        ...
        `;return}}try{const r=c.default,d=new r(a);this.root.innerHTML="",this.root.appendChild(await d.render()),d.afterRender&&d.afterRender(),s==="/"&&(typeof window.requestIdleCallback=="function"?window.requestIdleCallback(()=>{D["/anime"]().catch(()=>{}),D["/watch"]().catch(()=>{})}):setTimeout(()=>{D["/anime"]().catch(()=>{}),D["/watch"]().catch(()=>{})},1500)),window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0}catch(r){console.error("Error al inicializar o renderizar la página:",r),this.root.innerHTML=`<div style="padding: 100px; text-align: center; color: red; font-family:'Outfit';"><h3>Error al renderizar el contenido</h3></div>`}}}let R=null;const W=f=>(!R&&f&&(R=new N(f)),R);class F{constructor(e){this.params=e,this.animeId=parseInt(e.id),this.episodeNum=parseInt(e.ep)||1,this.lang=e.lang||"sub",this.anime=null,this.localInfo=null,this.episodeData=null,this.relatedAnimes=[],this.anilistEpisodes=[],this.isFav=!1,this.watchedEpisodes=new Set,this.isTheater=localStorage.getItem("watch-theater-mode")==="true",this.isAmbient=localStorage.getItem("watch-ambient-mode")!=="false",this.sortDesc=!1,this.searchQuery=""}async render(){var o,c,r,d,L,E;try{console.log("Iniciando carga de WatchPage Premium para ID:",this.animeId,"Episodio:",this.episodeNum);const u=await C.getAnimeInfo(this.animeId);u&&u.data&&(this.anime=u.data);const g=new URLSearchParams(window.location.search).get("title"),p=[];if(this.anime&&(p.push(this.anime.title),this.anime.title_english&&p.push(this.anime.title_english),this.anime.title_japanese&&p.push(this.anime.title_japanese),this.anime.title_synonyms&&p.push(...this.anime.title_synonyms)),g&&!p.includes(g)&&p.push(g),p.length>0){let y=null;for(const b of p){const w=await C.searchLocal(b);if(w&&w.success&&w.data&&w.data.results&&w.data.results.length>0){y=w;break}}if(y){const b=y.data.results.find(m=>p.some(x=>m.title.toLowerCase().includes(x.toLowerCase())))||y.data.results[0];this.anime||(this.anime={title:b.title,images:{jpg:{large_image_url:b.thumbnail}},genres:[],synopsis:"Cargado desde el servidor local de AniRD."});const w=await C.getAnimeInfo(b.url);if(w.success){this.localInfo=w.data;const m=this.localInfo.episodes.find(x=>x.number===this.episodeNum);if(m&&m.url){const x=await C.getEpisode(m.url);if(x.success&&x.data){this.episodeData=x.data;let A=this.episodeData.servers[this.lang];if(!A||A.length===0)if(this.lang==="dub"&&this.episodeData.servers.sub&&this.episodeData.servers.sub.length>0){this.lang="sub",A=this.episodeData.servers.sub,T.show("El episodio no tiene doblaje disponible. Reproduciendo subtitulado.","info");const k=window.location.href.replace("/dub","/sub");window.history.replaceState({},"",k)}else A=this.episodeData.servers.sub||[];this.episodeData.activeServers=A}}}}}this.isFav=await _.isFavorite(this.animeId);const v=await S.history.where({animeId:String(this.animeId)}).toArray();this.watchedEpisodes=new Set(v.map(y=>Number(y.episodeId)))}catch(u){console.error("Error crítico al renderizar WatchPage Premium:",u)}const e=document.createElement("div");if(e.className="page-enter",!this.anime)return e.innerHTML=`
      ...
      `,e;document.title=`${this.anime.title} — Episodio ${this.episodeNum} (${this.lang.toUpperCase()}) — AniRD`;const t=this.watchedEpisodes.has(this.episodeNum),s=`https://anilist.co/search/anime?search=${encodeURIComponent(this.anime.title)}`,a=`https://myanimelist.net/anime/${this.anime.mal_id||""}`,n=((c=(o=this.anime.images)==null?void 0:o.jpg)==null?void 0:c.large_image_url)||"",l=((d=(r=this.anime.images)==null?void 0:r.jpg)==null?void 0:d.large_image_url)||n;let i="";if(this.anime.status==="Currently Airing"&&this.anime.broadcast&&this.anime.broadcast.time){const u=this.anime.broadcast,h={Sundays:0,Mondays:1,Tuesdays:2,Wednesdays:3,Thursdays:4,Fridays:5,Saturdays:6};if(h[u.day]!==void 0){const[g,p]=u.time.split(":").map(Number),v=new Date(new Date().toLocaleString("en-US",{timeZone:u.timezone||"Asia/Tokyo"}));let y=new Date(v);y.setHours(g,p,0,0);let b=h[u.day]-v.getDay();(b<0||b===0&&y<v)&&(b+=7),y.setDate(y.getDate()+b),y-v>0&&(i=`
      ...
      <div class="ambient-glow" id="ambient-glow" style="background-image: url('${l}'); transition: opacity 0.8s ease; ${this.isAmbient?"opacity: 0.6; display: block;":"opacity: 0; display: none;"}"></div>
    ...
    `,e}async afterRender(){const e=document.getElementById("video-container");if(e&&this.episodeData&&this.episodeData.activeServers&&this.episodeData.activeServers.length>0&&this._renderActiveServerPlayer(e,this.episodeData.activeServers[0]),this._initPlayerControls(),this._initPlayerEnhancements(),this._initServerPills(),this._initSynopsisExpand(),this._initWatchedToggleControls(),this._loadEnrichedEpisodesAndRecommendations(),window.activeWatchInterval&&(clearInterval(window.activeWatchInterval),window.activeWatchInterval=null),this.anime){const s=this.watchedEpisodes.has(this.episodeNum),a=document.getElementById("btn-watched-status"),n=document.getElementById("watched-status-text");s?(a&&a.classList.add("active"),n&&(n.textContent="Visto")):(a&&a.classList.remove("active"),n&&(n.textContent="Marcar Visto"),this.watchTimeCounter=0,window.activeWatchInterval=setInterval(async()=>{var i,o;if(!document.getElementById("watch-layout")){document.body.classList.remove("tv-fullscreen-active"),document.body.classList.remove("mobile-fullscreen-active"),clearInterval(window.activeWatchInterval),window.activeWatchInterval=null;return}if(!document.hidden&&(this.watchTimeCounter++,this.watchTimeCounter>=120)){clearInterval(window.activeWatchInterval),window.activeWatchInterval=null,console.log("[WatchTimer] 2 minutos cumplidos. Marcando como visto automáticamente.");const c=this.anime?{animeTitle:this.anime.title,animeCover:((o=(i=this.anime.images)==null?void 0:i.jpg)==null?void 0:o.large_image_url)||this.anime.cover||"",animeType:this.anime.type||"",animeScore:this.anime.score||""}:{};await _.addToHistory(String(this.animeId),this.episodeNum,120,120,c),this.watchedEpisodes.add(this.episodeNum),a&&a.classList.add("active"),n&&(n.textContent="Visto"),this.renderEpisodes&&this.renderEpisodes()}},1e3))}const t=document.getElementById("btn-close-mobile-fs");t&&t.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation();const a=document.getElementById("video-container");if(a){a.classList.remove("mobile-fullscreen-active"),document.body.classList.remove("mobile-fullscreen-active");const n=document.getElementById("btn-fullscreen-watch"),l=n?n.querySelector("span"):null;l&&(l.textContent="Pantalla Completa")}}),this._globalKeyHandler=s=>{if(!document.getElementById("watch-layout")){document.body.classList.remove("tv-fullscreen-active"),document.body.classList.remove("mobile-fullscreen-active"),window.removeEventListener("keydown",this._globalKeyHandler,{capture:!0});return}if(s.key==="Escape"||s.key==="Backspace"){const n=document.getElementById("video-container");if(n&&n.classList.contains("mobile-fullscreen-active")){n.classList.remove("mobile-fullscreen-active"),document.body.classList.remove("mobile-fullscreen-active");const l=document.getElementById("btn-fullscreen-watch"),i=l?l.querySelector("span"):null;i&&(i.textContent="Pantalla Completa"),s.preventDefault(),s.stopPropagation()}}},window.addEventListener("keydown",this._globalKeyHandler,{capture:!0})}_initPlayerEnhancements(){const e=document.querySelector(".video-wrapper-v5 iframe"),t=document.getElementById("btn-speed"),s=document.getElementById("speed-dropdown"),a=document.getElementById("speed-text");t&&s&&(t.addEventListener("click",i=>{i.stopPropagation();const o=s.classList.contains("open");s.classList.toggle("open",!o)}),s.querySelectorAll(".speed-option").forEach(i=>{i.addEventListener("click",async o=>{o.stopPropagation();const c=parseFloat(i.dataset.speed);if(s.querySelectorAll(".speed-option").forEach(r=>r.classList.remove("active")),i.classList.add("active"),a&&(a.textContent=`${c}x`),s.classList.remove("open"),e&&e.contentWindow)try{e.contentWindow.postMessage(JSON.stringify({event:"command",func:"setPlaybackRate",args:[c]}),"*")}catch{}await _.setSetting("playback_speed",c),T.info(`Velocidad: ${c}x`,c===1?"Velocidad normal":`Reproduciendo a ${c}x`)})}),_.getSetting("playback_speed",1).then(i=>{i&&i!==1&&(a&&(a.textContent=`${i}x`),s.querySelectorAll(".speed-option").forEach(o=>{o.classList.toggle("active",parseFloat(o.dataset.speed)===i)}))}),document.addEventListener("click",i=>{i.target.closest("#speed-control-wrapper")||s.classList.remove("open")}));const n=document.getElementById("btn-skip-intro");n&&n.addEventListener("click",()=>{if(e&&e.contentWindow)try{e.contentWindow.postMessage(JSON.stringify({event:"command",func:"seekTo",args:[85]}),"*"),T.info("Saltando OP","Avanzando al minuto 1:25")}catch{}});const l=document.getElementById("btn-skip-outro");l&&l.addEventListener("click",()=>{if(e&&e.contentWindow)try{e.contentWindow.postMessage(JSON.stringify({event:"command",func:"seekTo",args:[1290]}),"*"),T.info("Saltando ED","Avanzando al minuto 21:30")}catch{}})}_getAutoplayUrl(e){if(!e)return"";if(!(document.body.classList.contains("tv-mode")||localStorage.getItem("tvMode")==="true"))return e;try{const s=e.startsWith("//"),a=s?"https:"+e:e,n=new URL(a);n.searchParams.set("autoplay","1"),n.searchParams.set("auto","1");let l=n.toString();return s&&(l=l.replace(/^https:/,"")),l}catch{const a=e.includes("?")?"&":"?";return`${e}${a}autoplay=1&auto=1`}}_initPlayerControls(){const e=document.getElementById("watch-layout"),t=document.getElementById("player-section"),s=document.getElementById("main-column"),a=document.getElementById("dim-overlay"),n=document.getElementById("ambient-glow"),l=document.getElementById("btn-theater"),i=document.getElementById("btn-lights"),o=document.getElementById("btn-ambient"),c=document.getElementById("btn-favorite"),r=document.getElementById("lights-text"),d=document.getElementById("theater-text"),L=document.getElementById("fav-text"),E=p=>{if(document.body.classList.contains("tv-mode")||localStorage.getItem("tvMode")==="true"){e.classList.remove("theater-active"),t.parentElement!==e&&e.insertBefore(t,e.firstChild);return}p?(e.classList.add("theater-active"),e.insertBefore(t,e.firstChild),d&&(d.textContent="Modo Normal")):(e.classList.remove("theater-active"),s.insertBefore(t,s.firstChild),d&&(d.textContent="Modo Cine"))};E(this.isTheater),l&&l.addEventListener("click",()=>{this.isTheater=!this.isTheater,localStorage.setItem("watch-theater-mode",this.isTheater),l.classList.toggle("active",this.isTheater),E(this.isTheater)});const u=p=>{const v=p!==void 0?p:!a.classList.contains("active");a.classList.toggle("active",v),t.classList.toggle("dimmed-active",v),i.classList.toggle("active",v),r&&(r.textContent=v?"Encender Luces":"Apagar Luces")};i&&i.addEventListener("click",()=>u()),a&&a.addEventListener("click",()=>u(!1)),o&&n&&o.addEventListener("click",()=>{this.isAmbient=!this.isAmbient,localStorage.setItem("watch-ambient-mode",this.isAmbient),o.classList.toggle("active",this.isAmbient),this.isAmbient?(n.style.display="block",n.offsetHeight,n.style.opacity="0.6",T.info("Modo Ambiente","Resplandor dinámico activado")):(n.style.opacity="0",setTimeout(()=>{this.isAmbient||(n.style.display="none")},800),T.info("Modo Ambiente","Resplandor dinámico desactivado"))}),c&&c.addEventListener("click",async()=>{if(!this.anime)return;const p=await _.toggleFavorite(this.anime);this.isFav=p,c.classList.toggle("active",p),L&&(L.textContent=p?"Quitar Favorito":"Favorito")});const h=document.getElementById("btn-back-watch");h&&h.addEventListener("click",p=>{p.preventDefault(),window.history.back()});const g=document.getElementById("btn-fullscreen-watch");g&&g.addEventListener("click",p=>{p.preventDefault();const v=document.body.classList.contains("tv-mode")||localStorage.getItem("tvMode")==="true",y=window.innerWidth<=900||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),b=window.Android!==void 0,w=document.getElementById("video-container");if(w)if(b){const m=document.querySelector(".video-wrapper-v5 iframe, iframe");m&&(m.requestFullscreen?m.requestFullscreen():m.webkitRequestFullscreen?m.webkitRequestFullscreen():m.mozRequestFullScreen?m.mozRequestFullScreen():m.msRequestFullscreen&&m.msRequestFullscreen())}else if(v){document.body.classList.toggle("tv-fullscreen-active");const m=document.body.classList.contains("tv-fullscreen-active");w.classList.toggle("tv-fullscreen-active",m);const x=g.querySelector("span");x&&(x.textContent=m?"Salir Pantalla":"Pantalla Completa")}else if(y){document.body.classList.toggle("mobile-fullscreen-active");const m=document.body.classList.contains("mobile-fullscreen-active");w.classList.toggle("mobile-fullscreen-active",m);const x=g.querySelector("span");x&&(x.textContent=m?"Salir Pantalla":"Pantalla Completa")}else{const m=document.querySelector(".video-wrapper-v5 iframe");m&&(m.requestFullscreen?m.requestFullscreen():m.webkitRequestFullscreen?m.webkitRequestFullscreen():m.mozRequestFullScreen?m.mozRequestFullScreen():m.msRequestFullscreen&&m.msRequestFullscreen())}})}_renderActiveServerPlayer(e,t){if(!e||!t||!t.url)return;const s=t.url;e.innerHTML=`
      <iframe src="${this._getAutoplayUrl(s)}" allowfullscreen allow="autoplay; encrypted-media"></iframe>
      <button class="mobile-close-fullscreen-btn" id="btn-close-mobile-fs">✕</button>
    `}_initServerPills(){const e=document.querySelectorAll(".server-pill-v5"),t=document.getElementById("video-container");e.forEach((a,n)=>{a.addEventListener("click",l=>{var r;e.forEach(d=>d.classList.remove("active")),a.classList.add("active");const i=((r=this.episodeData)==null?void 0:r.activeServers)||[],o=a.getAttribute("data-url"),c=i[n]||{url:o};t&&c.url&&(this._renderActiveServerPlayer(t,c),t.style.opacity="0.5",setTimeout(()=>t.style.opacity="1",500))})}),document.querySelectorAll(".lang-pill-v5").forEach(a=>{a.addEventListener("click",n=>{const l=a.getAttribute("data-lang"),i=`/watch/${this.animeId}/${this.episodeNum}/${l}?title=${this.anime?encodeURIComponent(this.anime.title):""}`,o=W();o?o.navigate(i):window.location.href=i})})}_initSynopsisExpand(){const e=document.getElementById("synopsis-box"),t=document.getElementById("btn-more-synopsis");t&&e&&t.addEventListener("click",()=>{const s=e.classList.toggle("expanded");t.textContent=s?"... ver menos":"... ver más"})}_startCountdownTimer(e,t){let s=e-t;const a=setInterval(()=>{const n=document.getElementById("countdown-timer");if(!n){clearInterval(a);return}if(s-=1e3,s<=0){n.textContent="¡Disponible ya en Emisión!",clearInterval(a);return}const l=Math.floor(s/864e5),i=Math.floor(s%864e5/36e5),o=Math.floor(s%36e5/6e4),c=Math.floor(s%6e4/1e3);let r="";l>0&&(r+=`${l}d `),(i>0||l>0)&&(r+=`${i}h `),r+=`${o}m ${c}s`,n.textContent=r},1e3)}async _loadEnrichedEpisodesAndRecommendations(){var n,l;const e=document.getElementById("related-grid"),t=document.getElementById("sidebar-ep-list"),[s,a]=await Promise.all([C.getAnimeRecommendations(this.animeId).catch(()=>null),C.getAnilistEpisodes(this.animeId).catch(()=>[])]);if(e)if(s&&s.data&&s.data.length>0){const i=s.data.slice(0,6);e.innerHTML=i.map(o=>{var c,r;return`
          <a href="/anime/${o.entry.mal_id}" data-link class="related-card-v5">
            <img src="${(r=(c=o.entry.images)==null?void 0:c.jpg)==null?void 0:r.image_url}" class="related-img-v5" alt="${o.entry.title}">
            <div class="related-info-v5">
              <h4 class="related-title-v5">${o.entry.title}</h4>
              <span class="related-meta-v5">Recomendado</span>
            </div>
          </a>
        `}).join("")}else e.innerHTML='<p style="color:var(--text-muted); font-size:12px; font-weight:600;">No hay recomendaciones similares disponibles.</p>';if(this.localInfo&&this.localInfo.episodes){const i=this.localInfo.episodes,o=((l=(n=this.anime.images)==null?void 0:n.jpg)==null?void 0:l.large_image_url)||"",c=this.anime.title,r=()=>{let E=[...i];if(this.sortDesc&&E.reverse(),this.searchQuery.trim()!==""&&(E=E.filter(h=>String(h.number).includes(this.searchQuery)||h.title&&h.title.toLowerCase().includes(this.searchQuery.toLowerCase()))),E.length===0){t.innerHTML='<p style="color:var(--text-muted); text-align:center; padding:20px; font-size:11px;">No se encontraron episodios.</p>';return}t.innerHTML=E.map(h=>{let g=`Episodio ${h.number}`,p=o;const v=a[h.number-1];if(v&&(v.title&&(g=v.title.replace(/^Episode \d+\s*-?\s*/i,"")),v.thumbnail&&(p=v.thumbnail)),h.number===this.episodeNum){const A=document.getElementById("active-episode-title");A&&(A.textContent=`${this.anime.title} — ${g}`)}const y=h.number===this.episodeNum,b=this.watchedEpisodes.has(h.number),w=`/watch/${this.animeId}/${h.number}/${this.lang}?title=${encodeURIComponent(c)}`,m=b?'<div class="ep-watched-badge-v5">✓ Visto</div>':"",x=b?'<div class="ep-progress-bar-v5"><div class="ep-progress-fill-v5"></div></div>':"";return`
        ...
        `)}_initWatchedToggleControls(){const e=document.getElementById("btn-watched-status"),t=document.getElementById("watched-status-text"),s=document.getElementById("btn-watched-all");e&&e.addEventListener("click",async()=>{var n,l;const a=this.watchedEpisodes.has(this.episodeNum);if(window.activeWatchInterval&&(clearInterval(window.activeWatchInterval),window.activeWatchInterval=null),a){const i=await S.history.where({animeId:String(this.animeId),episodeId:this.episodeNum}).first();i&&await S.history.delete(i.id),this.watchedEpisodes.delete(this.episodeNum),e.classList.remove("active"),t&&(t.textContent="Marcar Visto"),await _.triggerSync()}else{const i=this.anime?{animeTitle:this.anime.title,animeCover:((l=(n=this.anime.images)==null?void 0:n.jpg)==null?void 0:l.large_image_url)||this.anime.cover||"",animeType:this.anime.type||"",animeScore:this.anime.score||""}:{};await _.addToHistory(String(this.animeId),this.episodeNum,120,120,i),this.watchedEpisodes.add(this.episodeNum),e.classList.add("active"),t&&(t.textContent="Visto")}this.renderEpisodes&&this.renderEpisodes()}),s&&s.addEventListener("click",async()=>{if(!this.localInfo||!this.localInfo.episodes)return;const n=this.localInfo.episodes.map(i=>i.number);if(window.activeWatchInterval&&(clearInterval(window.activeWatchInterval),window.activeWatchInterval=null),n.every(i=>this.watchedEpisodes.has(i)))await S.transaction("rw",S.history,async()=>{for(const i of n){const o=await S.history.where({animeId:String(this.animeId),episodeId:i}).first();o&&await S.history.delete(o.id)}}),n.forEach(i=>this.watchedEpisodes.delete(i)),this.watchedEpisodes.has(this.episodeNum)?(e&&e.classList.add("active"),t&&(t.textContent="Visto")):(e&&e.classList.remove("active"),t&&(t.textContent="Marcar Visto"));else{const i=Date.now();await S.transaction("rw",S.history,async()=>{for(const o of n)await S.history.where({animeId:String(this.animeId),episodeId:o}).first()||await S.history.add({animeId:String(this.animeId),episodeId:o,progress:120,duration:120,timestamp:i,updatedAt:i})}),n.forEach(o=>this.watchedEpisodes.add(o)),this.watchedEpisodes.has(this.episodeNum)?(e&&e.classList.add("active"),t&&(t.textContent="Visto")):(e&&e.classList.remove("active"),t&&(t.textContent="Marcar Visto"))}await _.triggerSync(),this.renderEpisodes&&this.renderEpisodes()})}}const V=Object.freeze(Object.defineProperty({__proto__:null,default:F},Symbol.toStringTag,{value:"Module"}));export{I as _,W as g,O as u};
