const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-homepage-Ditd0iT1.js","assets/vendor-DIPEJTOH.js"])))=>i.map(i=>d[i]);
import{_ as v}from"./page-favoritespage-L8ApJ8Wm.js";import{c as b,b as m,d as p}from"./page-homepage-Ditd0iT1.js";import"./vendor-DIPEJTOH.js";class I{constructor(i){this.params=i,this.user=b.getUser(),this.activeTab="list",this.followedAnimes=[],this.favoriteAnimes=[],this.stats={favs:0,list:0,epis:0}}async render(){if(!this.user)return window.location.href="/auth",document.createElement("div");this.followedAnimes=await m.following.toArray(),this.favoriteAnimes=await m.favorites.toArray(),this.stats={favs:this.favoriteAnimes.length,list:this.followedAnimes.length,epis:await m.history.count()};const i=document.createElement("div");return i.className="page-container",i.innerHTML=`
      <style>
        .profile-hero-v5 {
          height: 350px;
          position: relative;
